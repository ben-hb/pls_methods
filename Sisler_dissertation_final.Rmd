...
glm_prem <- glm(si_type ~ sexual + gender_tgd + sib_freq + race + ed_any + dx_mh + undercls +
                  ...
                  residenc_3 + residenc_4 + meds_any + ins_no + satisfied_overall, family = binomial(link = "logit"),
              data = glm_prem)
summary(glm_prem)
...
glm_le <- glm(si_type ~ gpa_sr + assault + binge + drugs_yn + drug_mar + 
                psyhx + fincur + ther, family = binomial(link = "logit"),
              data = glm_le)
summary(glm_le)
coef(glm_le)
...
# run MM regression
glm_all <- glm(si_type ~ ., family = binomial(link = "logit"),
              data = glm_all)
