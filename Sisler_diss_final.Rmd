...
```{r race reconciliation}
  #decline to answer
data.v6$race[str_detect(data.v6$race_other_text, "[A|a]merica")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[H|h]uman")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[N|n]one")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[P|p]erson")] <- 1
data.v6$race[data.v6$race_other_text %in% c("prefer not to say", "Prefer not to answer.", "Prefer not to specify", 
                                            ...
                                            "I won't allow my race to be used in this study for potential insidious usage")]  <- 1
...
data.v6$race[data.v6$race_other_text %in% c("Volvo", "Vulcan", "Snowman", "tree", "General Electric", "Cat", "Earthling", 
                                            ...
                                            "Desert Camoflauge",  "Attack helicopter", "Ethnic Kekistani")] <- 1

  # white
data.v6$race[str_detect(data.v6$race_other_text, "[J|j]ew")] <- 0  # if Israeli, could be White, Asian, or ME (e.g. Palestine)
data.v6$race[str_detect(data.v6$race_other_text, "[A|a]shkenazi")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[C|c]aucasian")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[E|e]uropean")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[G|g]reek")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[I|i]rish")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[I|i]talian")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[A|a]lbania")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[S|s]em[e|i]tic")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[R|r]ussian")] <- 0 # could be Asian depending on region
data.v6$race[str_detect(data.v6$race_other_text, "[R|r]oma")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[T|t]urkish")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[S|s]lavic")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[M|m]etis")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[B|b]asque")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[S|s]icilian")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[P|p]olish")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[S|s]candinavian")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[F|f]innish")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[C|c]eltic")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[S|s]cottish")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[C|c]anad")] <- 0
data.v6$race[str_detect(data.v6$race_other_text, "[M|m]editerranean")] <- 0
data.v6$race[data.v6$race_other_text %in% c("please refer to me as Caucasian; it's extremely offensive to refer to every race-- excluding Caucasians-- in their politically correct form",
                                            ...
                                            "White (Jewish/Jamaican-Chinese/Irish)", "ARMENIAN")] <- 0
  # Identifies as American Indian or other indigenous descent
data.v6$race[str_detect(data.v6$race_other_text, "[N|n]ative [A|a]merican")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[I|i]ndigenous")] <- 1
data.v6$race[data.v6$race_other_text %in% c("I look white but im also status native", "Indigenous/Mestizo", 
                                            "american indian that isn'y legally claimed")] <- 1
  # Identifies as Asian
...
data.v6$race[str_detect(data.v6$race_other_text, "[M|m]exican")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[X|x]ican[o|a]")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[L|l]atin[o|a]")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[P|p]uerto [R|r]ican")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[S|s]panish")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[C|c]hican[o|a]")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[I|i]berian")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[M|m]estiz[o|a]")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[P|p]ortuguese")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[B|b]razil")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[C|c]uba")] <- 1
data.v6$race[data.v6$race_other_text %in% c("Costa Rican", "Central American Native", "Andean")] <- 1

  # Identifies as Middle Eastern or of Arab descent
data.v6$race[str_detect(data.v6$race_other_text, "[A|a]rmenia")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[P|p]akistani")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[A|a]rab")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[P|p]ersian")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[P|p]alestin")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[I|i]srael")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[A|a]fghan")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[N|n]orth [A|a]frica")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[H|h]azara")] <- 1
data.v6$race[data.v6$race_other_text %in% c("Northern African; Moroccan; Israeli", "Arab Mix", "Berber/North African", 
                                            "Coptic Egyptian (non-Arab)", "Kekistani")] <- 1

  # Identifies all other data or mixed ethicity
data.v6$race[str_detect(data.v6$race_other_text, "[B|b]iracial")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[B|b]i-racial")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[M|m]ix")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[H|h]alf")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[I|i]ndo-[C|c]arribean")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[M|m]ulti")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[M|m]ulatto")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[P|p]anda")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[O|o]ther")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[U|u]nkown")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[A|a]mbiguous")] <- 1
data.v6$race[str_detect(data.v6$race_other_text, "[A|a]mbiguous")] <- 1
data.v6$race[data.v6$race_other_text %in% c("Sub Asian/East African", "two or more races", "Moroccan Mexican",
                                            ...
                                            "An American Mutt- a bit of everything somewhere in there")] <- 1
  # Identifies as black and white as 'Other/Mixed'
data.v6$race[data.v6$race_other_text %in% c("Black/White","White/African American", "White/African American")] <- 1
  # Identifies as Asian and White as 'Other/Mixed'
data.v6$race[str_detect(data.v6$race_other_text, "[E|e]urasian")] <- 1
data.v6$race[data.v6$race_other_text %in% c("Japanese, Chinese, French, British, Greek", "Asian/White",
                                            ...
                                            "White & Asian", "Chinese and White")] <- 1
...
data.v6$race[data.v6$race_other_text %in% c("I am 1/4th Hispanic 3/4 German",  "Honduran, Irish", "White hispanic",
                                            ...
                                            "If I identify as puerto rican does that mean i get more scholarship money?")] <- 1
	 # Identifies as MR and White as 'Other/Mixed'
data.v6$race[data.v6$race_other_text %in% c("Half Middle Eastern half white", 
                                            "Half my family is white and the other middle eastern")] <- 1

table(data.v6$race, useNA = "always") # tabulate and check outputs
```
...
data.v7 <- data.v6 %>%
  mutate(sib_freq = case_when(sib_none == 1 ~ 0,    # none
                              ...
                              sib_freq == 4 ~ 1,    # 1-2x/wk
                              sib_freq == 5 ~ 1,    # 3-5x/wk
                              sib_freq == 6 ~ 1)) %>%  # almost everyday
...
table(data.v7$ed_scoff)  # check output
...
traindf.v13 = subset(traindf.v13, select= -c(ins_1, ins_mh, ins_ade, ins_inade)) # clean up var
```
...
traindf_prem <- traindf.v15 %>% select(race, undercls, sexual, gender_tgd, sib_freq, ed_any, 
                                       dx_mh, international, meds_any, religios, school2_type, finpast,
                                       ins_no, residenc, satisfied_overall)

traindf_prem <- dummy_cols(traindf_prem, select_columns = c("race", "school2_type", "residenc"),
                         remove_first_dummy = TRUE, remove_selected_columns = TRUE)

traindf_prem.cor <- data.matrix(traindf_prem)
traindf_prem.cor = cor(traindf_prem.cor, method = c("spearman"))
view(traindf_prem.cor)
...
corr_simple <- function(traindf=traindf_prem, sig=0.6){
  ...
  corr <- cor(traindf_prem, use = "pairwise.complete.obs", method = "spearman")                               
...
```{r train clm_prem}
glm_prem <- traindf.v15 %>% select(si_type, sexual, gender_tgd, sib_freq, race, ed_any, finpast,
                                   dx_mh, international, religios, school2_type, residenc, ins_no,
                                   meds_any, undercls, satisfied_overall)
glm_prem <- dummy_cols(glm_prem, select_columns = c("school2_type", "residenc"),
                         remove_first_dummy = TRUE, remove_selected_columns = TRUE)
glm_prem <- na.omit(glm_prem)

# run regression
glm_prem <- glm(si_type ~ sexual + gender_tgd + sib_freq + race + ed_any + dx_mh + undercls +
                  finpast + religios +  school2_type_2 + school2_type_2 + international + residenc_2 + 
                  residenc_3 + residenc_4 + meds_any + ins_no + satisfied_overall, family = binomial("logit"),
              data = glm_prem)
summary(glm_prem)
...
table(traindf.v16$fincur, useNA = "always")  # check output
```
...
## Therapy
```{r ther}
# create new var for recent therapy utilization
traindf.v18 <- traindf.v18 %>%
  mutate(ther = case_when(ther_cur == 1 ~ 1,
                          ...
                          ther_ever == 0 ~ 0)) %>%
    filter(!is.na(ther))
traindf.v18$ther <- as.logical(traindf.v18$ther)

table(traindf.v18$ther, useNA = "always")
```
...
traindf_le <- traindf.v19 %>% select(gpa_sr, fincur, binge, assault, drugs_yn, drug_mar, psyhx, ther)

# convert traindf to numeric in order to run correlations
traindf_le <- traindf_le %>% mutate_if(is.character, as.factor)
traindf_le <-  traindf_le %>% mutate_if(is.factor, as.numeric)

traindf_le.cor <- data.matrix(traindf_le)
traindf_le.cor = cor(traindf_le.cor, method = c("spearman"))
view(traindf_le.cor)

# run a correlation and drop the insignificant ones
corr <- cor(traindf_le, use = "pairwise.complete.obs", method = "spearman")                               
...
glm_le <- traindf.v19 %>% select(si_type, gpa_sr, assault, binge, drugs_yn, 
                                 drug_mar, psyhx, fincur, ther)
glm_le <- na.omit(glm_le)

# run regression
glm_le <- glm(si_type ~ gpa_sr + assault + binge + drugs_yn + drug_mar + 
                psyhx + fincur + ther, family = binomial("logit"),
              data = glm_le)
summary(glm_le)
coef(glm_le)
...
table(traindf.v20$aca_impa, useNA = "always") # check output
```
...
table(traindf.v20$dep_impa, useNA = "always")  # check output, NAs
```
...
traindf_def <- traindf.v21 %>% select(aca_impa, anx_score, deprawsc, percneed, dep_impa)

 # convert traindf to numeric in order to run correlations
traindf_def <- traindf_def %>% mutate_if(is.character, as.factor)
traindf_def <-  traindf_def %>% mutate_if(is.factor, as.numeric)

traindf_def.cor <- data.matrix(traindf_def)
traindf_def.cor = cor(traindf_def.cor, method = c("spearman"))
view(traindf_def.cor)


# run a correlation and drop the insignificant ones
corr <- cor(traindf_def, use = "pairwise.complete.obs", method = "spearman")                               
corr[lower.tri(corr, diag=TRUE)] <- NA        # prepare to drop duplicates and correlations of 1    
corr[corr %in% c(-1, 1)] <- NA                # drop perfect correlations
corr <- as.data.frame(as.table(corr))         # turn into a 3-column table
corr <- na.omit(corr)                         # remove the NA values from above 
...
glm_def <- glm(si_type ~ aca_impa + deprawsc + anx_score + percneed + gad7_impa + dep_impa, family = binomial(link = "logit"),
               data = glm_def)
...
traindf_mm <- traindf.v27 %>% select(inf, flourish, belong1, mh_stigma, talk, persist, aaq_tot)

 # convert traindf to numeric in order to run correlations
traindf_mm <- traindf_mm %>% mutate_if(is.character, as.factor)
traindf_mm <-  traindf_mm %>% mutate_if(is.factor, as.numeric)

# create corr matrix, using Spearman
traindf_mm.cor <- data.matrix(traindf_mm)
traindf_mm.cor = cor(traindf_mm.cor, method = c("spearman"))
view(traindf_mm.cor)

# run a correlation and drop the insignificant ones
corr <- cor(traindf_mm, use = "pairwise.complete.obs", method = "spearman")                               
corr[lower.tri(corr,diag=TRUE)] <- NA                   # prepare to drop duplicates and correlations of 1    
corr[corr %in% c(-1, 1)] <- NA                          # drop perfect correlations
corr <- as.data.frame(as.table(corr))                   # turn into a 3-column table
corr <- na.omit(corr)                                   # remove the NA values from above 
...
glm_mmtsm <- traindf.v27 %>% select(si_type, inf, flourish, belong1, talk, mh_stigma, persist, aaq_tot)
glm_mmtsm <- na.omit(glm_mmtsm)

# run MM regression
glm_mmtsm <- glm(si_type ~ inf + flourish + belong1 + mh_stigma + talk + persist + aaq_tot, family = binomial(link = "logit"),
              data = glm_mmtsm)
...
glm_all <- traindf.v27 %>% select(
  ...
  si_type,
  # premotivation
  sexual, sib_freq, dx_mh, satisfied_overall, finpast,
  # life events
  psyhx, fincur, assault, ther,
  # defeat-entrapment
  deprawsc, anx_score, percneed,
  # threats to internal/external moderation
  flourish, aaq_tot)

glm_all <- na.omit(glm_all)

# run MM regression
glm_all <- glm(si_type ~ ., family = binomial("logit"),
              data = glm_all)

summary(glm_all)
coef_mm <- coef(summary(glm_all))  # retrieve coefficients

ci_all <- confint(glm_all)  # retrieve confidence intervals
ci_all

model.all <- tidy(glm_all)  # Convert model to dataframe for easy manipulation
model.all

model.all  %>%
  mutate(or = exp(estimate),  # Odds ratio/gradient
        var.diag = diag(vcov(glm_all)),  # Variance of each coefficient
        or.se = sqrt(or^2 * var.diag))  # Odds-ratio adjusted
```
...
var_names <- c(
  ...
  "religios", "residenc", "school2_type", "international", "undercls", "satisfied_overall",
  # life events
  "ins_no", "gpa_sr", "psyhx", "fincur", "drugs_yn", "assault", "binge", "drug_mar", "ther",
  # defeat-entrapment
  "deprawsc", "anx_score", "dep_impa", "percneed",
  # threats
  "persist", "aaq_tot", "flourish", "talk")  
...
traindf_sem <- traindf.v28 %>% select(
  ...
  # premotivation
  age, sexual, race, gender_tgd, sib_freq, ed_any, dx_mh, meds_any, finpast,
  religios, international, undercls, ins_no,
  satisfied_overall,
  # life events
  gpa_sr, psyhx, fincur, drugs_yn, drug_mar, ther, assault,
  # defeat-entrapment
  deprawsc, anx_score, dep_impa, percneed,
  # threats to internal/external moderation
  persist, aaq_tot, flourish, talk)  
...
# create sem matrix 
traindf_sem <- traindf_sem %>% data.matrix()
...
# training data
var_desc_train <- describe(traindf_sem)
view(var_desc_train)

# xlsx output
save(var_desc_train, file = "var_desc_train.RData")
load("var_desc_train.RData")
write_xlsx(var_desc_train, path = "var_desc_train.xls", col_names = TRUE, format_headers = TRUE)
```
...
# create corr matrix
results_corr.cor <- data.matrix(results_corr)
results_corr.cor = cor(results_corr.cor, method = c("spearman"))
view(results_corr.cor)

# run a correlation and drop the insignificant ones 
sig <- 0.4
corr <- cor(results_corr, use = "pairwise.complete.obs", method = "spearman")                               
corr[lower.tri(corr,diag=TRUE)] <- NA                   # prepare to drop duplicates and correlations of 1    
corr[corr %in% c(-1, 1)] <- NA                          # drop perfect correlations
corr <- as.data.frame(as.table(corr))                   # turn into a 3-column table
corr <- na.omit(corr)                                   # remove the NA values from above  
...
traindf_sem1 <- traindf.v28 %>% select(
  ...
  # premotivation
  age, sexual, race, gender_tgd, sib_freq, ed_any, dx_mh, meds_any, finpast,
  religios, international, undercls, ins_no, race_bla, satisfied_overall,
  # life events
  gpa_sr, psyhx, fincur, drugs_yn, ther, drug_mar, assault, binge,
  # defeat-entrapment
  deprawsc, anx_score, dep_impa, percneed,
  # threats to internal/external moderation
  persist, aaq_tot, flourish, talk) 
...
traindf_sem1 <- as.data.frame(traindf_sem1)
  
## Dummy col SEM w/ continuous
# xlsx output
save(traindf_sem1, file = "traindf_pls.RData")
load("traindf_pls.RData")
write_xlsx(traindf_sem1, path = "traindf_pls_final.xlsx", col_names = TRUE, format_headers = TRUE)
```
...
table(testdf.v14$military, useNA = "always")
```
...
testdf.v14 <- testdf.v14 %>% 
  mutate(ins_no = case_when((ins_1 == 1 | ins_mh == 4 | 
                            ...
                            (ins_1 == 0 | ins_mh == 1 | 
                               ins_mh == 2 | ins_ade == 2) ~ 0)) %>% # adequate MH coverage
  filter(!is.na(ins_no))   
testdf.v14$ins_no <- as.logical(testdf.v14$ins_no) # switch class to boolean
table(testdf.v14$ins_no, useNA = "always")   # check output, skew

testdf.v14 = subset(testdf.v14, select= -c(ins_1, ins_mh, ins_ade, ins_inade)) # clean up var
```
...
testdf.v22 <- testdf.v20 %>%
  mutate(satisfied_overall = case_when(satisfied_overall == 1 ~ 6,  # reverse coding
                                       ...
                                       satisfied_overall == 6 ~ 1)) %>% 
  filter(!is.na(satisfied_overall))  # filters out NAs
testdf.v22$satisfied_overall <- as.numeric(testdf.v22$satisfied_overall)

table(testdf.v22$satisfied_overall, useNA = "always")
```
...
testdf.v22$belong1 <- as.numeric(testdf.v22$belong1)
summary(testdf.v22$belong1)

table(testdf.v22$belong2)  # elective question, but common
table(testdf.v22$belong8)  # nested x 2
table(testdf.v22$belong9)  # not as good of a proxy
```
...
table(testdf.v24$inf, useNA ="always") # check output

testdf.v24 = subset(testdf.v24, select= -c(inf_1:inf_help))  # clean up vars
```
...
table(testdf.v24$brs_tot)
testdf.v24$brs_tot <- as.numeric(testdf.v24$brs_tot)

#  for loop for predictive cutoff point needed
rs_df <- data.frame("cutoff" = c(), "rs" = c())
for (i in 6:24) {
  brs_bin <- ifelse(testdf.v24$brs_tot >= i, TRUE, FALSE)
  model = lm(testdf.v24$sui_idea ~ brs_bin)
  rs_df <- rbind(rs_df, c(i, summary(model)$r.squared))
}
...
testdf.v24 <- testdf.v24 %>%
  ...
  mutate(brs_dum = case_when(brs_dum == 1 ~ 1,
                             brs_dum == 0 ~ 0))
testdf.v24$brs_dum <- as.logical(testdf.v24$brs_dum)

# output
rs_df_arranged[1,1]
table(testdf.v24$brs_tot, useNA = "always")
table(testdf.v24$brs_dum, useNA = "always")
```
...
testdf.v25 = subset(testdf.v25, select= -c(talk1_1:talk1_9, talk1sig, talk1fr, 
talk1rel, talk1no, talk1sup, talk1rm, talk1pro, talk1fam)) # clean up
```
...
## Therapy
```{r test ther}
# create new var for therapy utilization
testdf.v26 <- testdf.v26 %>%
  mutate(ther = case_when(ther_cur == 1 ~ 1,
                          ther_cur1 == 1 ~ 1,
                          ther_ever == 3 ~ 1,
...
testdf_sem <- testdf.v26 %>% select(
  ...
  # premotivation
  age, sexual, race, gender_tgd, sib_freq, ed_any, dx_mh, meds_any, finpast,
  religios, ins_no, international, undercls, satisfied_overall,
  # life events
  gpa_sr, psyhx, fincur, drugs_yn, ther, drug_mar, assault, binge,
  # defeat-entrapment
  deprawsc, anx_score, dep_impa, percneed,
...
# xlsx output
save(results_test, file = "testdf_pls_final.RData")
load("testdf_pls_final.RData")
...
test18_sem <- data.matrix(test18_sem)

test18_sem <- dummy_cols(test18_sem, select_columns = c("si_type", "race"),
                         remove_first_dummy = TRUE, remove_selected_columns = TRUE)

save(test18_sem, file = "test18_sem.RData")
load("test18_sem.RData")
write_xlsx(test18_sem, path = "test18_sem.xls", col_names = TRUE, format_headers = TRUE)
```
...
test20_sem <- dummy_cols(test20_sem, select_columns = c("si_type", "race"),
                         remove_first_dummy = TRUE, remove_selected_columns = TRUE)

# Save offline for SMART PLS
test20_sem <- as.data.frame(test20_sem)
save(test20_sem, file = "test20_sem.RData")
load("test20_sem.RData")
write_xlsx(test20_sem, path = "test20_sem.xls", col_names = TRUE, format_headers = TRUE)
```
...
set.seed(1000)
describe(test18.v26$age)
describe(test20.v26$age)
x <- rnorm(test18.v26$age)
ks.test(x, "pnorm")
x <- rnorm(test20.v26$age)
ks.test(x, "pnorm")
...
# training v. testing
    # age
    wilcox.test(testdf.v26B$age, traindf.v28B$age) # W = 16078586, p-value = 0.9389
    #finpst
    wilcox.test(testdf.v26B$finpast, traindf.v28B$finpast) # W = 16217970, p-value = 0.3662
    # satis
    wilcox.test(testdf.v26B$satisfied_overall, traindf.v28B$satisfied_overall) # W = 16217970, p-value = 0.3662
    # religios
    wilcox.test(testdf.v26B$religios, traindf.v28B$religios) # W = 16217970, p-value = 0.3662

    
    # si_type
    tt_si_compare <- rbind(table(testdf.v26B$si_type), table(traindf.v28B$si_type))
    tt_si_compare <- as.matrix(tt_si_compare)
    chisq_test(tt_si_compare, correct=F)  # statistic = 2.224666, p = 0.136
    # gender
    tt_gender_compare <- rbind(table(testdf.v26B$gender_tgd), table(traindf.v28B$gender_tgd))
    tt_gender_compare <- as.matrix(tt_gender_compare)
    chisq_test(tt_gender_compare, correct=F)  # statistic = 0.06002178, p = 0.806
    # sexual
    tt_sex_compare <- rbind(table(testdf.v26B$sexual), table(traindf.v28B$sexual))
    tt_sex_compare <- as.matrix(tt_sex_compare)
    chisq_test(tt_sex_compare, correct=F) # statistic = 0.1896632, p = 0.663
    # race
    tt_race_compare <- rbind(table(testdf.v26B$race), table(traindf.v28B$race))
    tt_race_compare <- as.matrix(tt_race_compare)
    chisq_test(tt_race_compare, correct=F) # statistic = 1.517476, p = 0.218
    # dx_mh
    tt_mh_compare <- rbind(table(testdf.v26B$dx_mh), table(traindf.v28B$dx_mh))
    tt_mh_compare <- as.matrix(tt_mh_compare)
    chisq_test(tt_mh_compare, correct=F) # statistic = 0.59196, p = 0.442
    # finpast

# 18-19 v. 20-25
    # age
    wilcox.test(test20.v26B$age, test18.v26B$age) # W = 6843144, p-value < 2.2e-16 ***
    # si_type
    sub_si_compare <- rbind(table(test20.v26B$si_type), table(test18.v26B$si_type))
    sub_si_compare <- as.matrix(sub_si_compare)
    chisq_test(sub_si_compare, correct=F)  # statistic = 12.40326, p = 0.000429 ***
    # gender
    sub_gender_compare <- rbind(table(test20.v26B$gender_tgd), table(test18.v26B$gender_tgd))
    sub_gender_compare <- as.matrix(sub_gender_compare)
    chisq_test(sub_gender_compare, correct=F)  # statistic = 10.78006, p = 0.00103 **
    # sexual
    sub_sex_compare <- rbind(table(test20.v26B$sexual), table(test18.v26B$sexual))
    sub_sex_compare <- as.matrix(sub_sex_compare)
    chisq_test(sub_sex_compare, correct=F) # statistic = 32.6071, p-value 1.13e-08	***
    # race
    sub_race_compare <- rbind(table(test20.v26B$race), table(test18.v26B$race))
    sub_race_compare <- as.matrix(sub_race_compare)
    chisq_test(sub_race_compare, correct=F) # statistic = 2.244755, p = 0.134
    # dx_mh
    sub_mh_compare <- rbind(table(test20.v26B$dx_mh), table(test18.v26B$dx_mh))
    sub_mh_compare <- as.matrix(sub_mh_compare)
    chisq_test(sub_mh_compare, correct=F) # statistic = 0.4700743, p = 0.493
    # activ_no
    sub_compare <- rbind(table(test20.v26B$activ_no), table(test18.v26B$activ_no))
    sub_compare <- as.matrix(sub_compare)
    chisq_test(sub_compare, correct=F) # statistic = 22.09264, p = < 2.6e-06	 ***
    # ed_any
    sub_compare <- rbind(table(test20.v26B$ed_any), table(test18.v26B$ed_any))
    sub_compare <- as.matrix(sub_compare)
    chisq_test(sub_compare, correct=F) # statistic = 1.544021, p = 0.214
    # international
    sub_compare <- rbind(table(test20.v26B$international), table(test18.v26B$international))
    sub_compare <- as.matrix(sub_compare)
    chisq_test(sub_compare, correct=F) # statistic = 33.28496, p = 7.96e-09		
    # meds_any
    sub_compare <- rbind(table(test20.v26B$meds_any), table(test18.v26B$meds_any))
    sub_compare <- as.matrix(sub_compare)
    chisq_test(sub_compare, correct=F) # statistic = 0.9975353, p = 0.318	
    # school2_4yr
    sub_compare <- rbind(table(test20.v26B$school2_4yr), table(test18.v26B$school2_4yr))
    sub_compare <- as.matrix(sub_compare)
    chisq_test(sub_compare, correct=F) # statistic = 16.77741, p = 4.2e-05
    # school2_cc
    sub_compare <- rbind(table(test20.v26B$school2_cc), table(test18.v26B$school2_cc))
    sub_compare <- as.matrix(sub_compare)
    chisq_test(sub_compare, correct=F) # statistic = 6.925147, p = 0.0085	
    # school2_ad
    sub_compare <- rbind(table(test20.v26B$school2_ad), table(test18.v26B$school2_ad))
    sub_compare <- as.matrix(sub_compare)
    chisq_test(sub_compare, correct=F) # statistic = 13.17342, p = 0.000284
    # sib_freq
    sub_compare <- rbind(table(test20.v26B$sib_freq), table(test18.v26B$sib_freq))
    sub_compare <- as.matrix(sub_compare)
    chisq_test(sub_compare, correct=F) # statistic = 33.28496, p = 0.00148
    # undercls
    sub_compare <- rbind(table(test20.v26B$undercls), table(test18.v26B$undercls))
    sub_compare <- as.matrix(sub_compare)
    chisq_test(sub_compare, correct=F) # statistic = 10.10105, p = 0.00148
    
    
```

# Premotivation var final
```{r final_vars}
...
set.seed(1000)
## age
describe(traindf.v28$age)
x <- rnorm(traindf.v28$age)
ks.test(x, "pnorm")
## finpast
describe(traindf.v28$finpast)
x <- rnorm(traindf.v28$finpast)
ks.test(x, "pnorm")
## religios
describe(traindf.v28$religios)
x <- rnorm(traindf.v28$religios)
ks.test(x, "pnorm")
## satisfied_overall
describe(traindf.v28$satisfied_overall)
x <- rnorm(traindf.v28$finpast)
ks.test(x, "pnorm")

## activ_no
table(traindf.v28$activ_no)
## dx_mh
table(traindf.v28$dx_mh)
## ed_any
table(traindf.v28$ed_any)
## international
table(traindf.v28$international)
## gender_tgd
table(traindf.v28$gender_tgd)
## international
table(traindf.v28$international)
## meds_any
table(traindf.v28$meds_any)
## race
table(traindf.v28$race)
## school2_type
table(traindf.v28$school2_type)
## sexual
table(traindf.v28$sexual)
## sib_freq
table(traindf.v28$sib_freq)
## undercls
table(traindf.v28$undercls)


set.seed(1000)
# premotivation test
describe(testdf.v26$age)
x <- rnorm(testdf.v26$age)
ks.test(x, "pnorm")
## finpast
describe(testdf.v26$finpast)
x <- rnorm(testdf.v26$finpast)
ks.test(x, "pnorm")
## religios
describe(testdf.v26$religios)
x <- rnorm(testdf.v26$religios)
ks.test(x, "pnorm")
## satisfied_overall
describe(testdf.v26$satisfied_overall)
x <- rnorm(testdf.v26$satisfied_overall)
ks.test(x, "pnorm")

## activ_no
table(testdf.v26$activ_no)
## dx_mh
table(testdf.v26$dx_mh)
## ed_any
table(testdf.v26$ed_any)
## gender_tgd
table(testdf.v26$gender_tgd)
## international
table(testdf.v26$international)
## meds_any
table(testdf.v26$meds_any)
## race
table(testdf.v26$race)
## school2_type
table(testdf.v26$school2_type)
## sexual
table(testdf.v26$sexual)
## sib_freq
table(testdf.v26$sib_freq)
## undercls
table(testdf.v26$undercls)
```
...
set.seed(1000)
## gpa_sr
describe(traindf.v28$gpa_sr)
x <- rnorm(traindf.v28$gpa_sr)
ks.test(x, "pnorm")
## assault
table(traindf.v28$assault)
table(testdf.v26$assault)
## psyhx
table(traindf.v28$psyhx)
## fincur
table(traindf.v28$fincur)
## drugs_yn
table(traindf.v28$drugs_yn)
## drug_mar
table(traindf.v28$drug_mar)

# Life events test
set.seed(1000)
## gpa_sr
describe(testdf.v26$gpa_sr)
x <- rnorm(testdf.v26$gpa_sr)
ks.test(x, "pnorm")
## assault

## psyhx
table(testdf.v26$psyhx)
## fincur
table(testdf.v26$fincur)
## drugs_yn
table(testdf.v26$drugs_yn)
## drug_mar
table(testdf.v26$drug_mar)

set.seed(1000)
# assault
tt_compare <- rbind(table(testdf.v26B$assault), table(traindf.v28B$assault))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 0.1896632, p = 0.663
# psyhx
tt_compare <- rbind(table(testdf.v26B$psyhx), table(traindf.v28B$psyhx))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 0.1896632, p = 0.663
#fincur
tt_compare <- rbind(table(testdf.v26B$fincur), table(traindf.v28B$fincur))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 0.1896632, p = 0.663
# drugs_yn
tt_compare <- rbind(table(testdf.v26B$drugs_yn), table(traindf.v28B$drugs_yn))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 0.1896632, p = 0.663
# drug_mar
tt_compare <- rbind(table(testdf.v26B$drug_mar), table(traindf.v28B$drug_mar))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 0.1896632, p = 0.663
```
...
# D-E variables final
```{r de_rev}
# Defeat-Entrapment train
set.seed(1000)
## anx_score
describe(traindf.v28$anx_score)
x <- rnorm(traindf.v28$anx_score)
ks.test(x, "pnorm")
## dep_impa
describe(traindf.v28$dep_impa)
x <- rnorm(traindf.v28$dep_impa)
ks.test(x, "pnorm")
## percneed
describe(traindf.v28$percneed)
x <- rnorm(traindf.v28$percneed)
ks.test(x, "pnorm")
## deprawsc
describe(traindf.v28$deprawsc)
x <- rnorm(traindf.v28$deprawsc)
ks.test(x, "pnorm")

wilcox.test(testdf.v26B$anx_score, traindf.v28B$anx_score) # W = 16087238, p-value = 0.900
wilcox.test(testdf.v26B$dep_impa, traindf.v28B$dep_impa) # W = 15988480, p-value = 0.6266
wilcox.test(testdf.v26B$percneed, traindf.v28B$percneed) # W = 19256866, p-value = <.001
wilcox.test(testdf.v26B$deprawsc, traindf.v28B$deprawsc) # W = 15920531, p-value = 0.4049

# Defeat-Entrapment test
set.seed(1000)
## percneed
describe(testdf.v26$percneed)
x <- rnorm(testdf.v26$percneed)
ks.test(x, "pnorm")
## anx_score
describe(testdf.v26$anx_score)
x <- rnorm(testdf.v26$anx_score)
ks.test(x, "pnorm")
## dep_impa
describe(testdf.v26$dep_impa)
x <- rnorm(testdf.v26$dep_impa)
ks.test(x, "pnorm")

## deprawsc
describe(testdf.v26$deprawsc)
x <- rnorm(testdf.v26$deprawsc)
ks.test(x, "pnorm")
```
...
set.seed(1000)
# aaq_tot
describe(traindf.v28$aaq_tot)
x <- rnorm(traindf.v28$aaq_tot)
ks.test(x, "pnorm")
## flourish
describe(traindf.v28$flourish)
x <- rnorm(traindf.v28$flourish)
ks.test(x, "pnorm")
## persist
describe(traindf.v28$persist)
x <- rnorm(traindf.v28$persist)
ks.test(x, "pnorm")
## talk
table(traindf.v28$talk)

# Threats test
set.seed(1000)
# aaq_tot
describe(testdf.v26$aaq_tot)
x <- rnorm(testdf.v26$aaq_tot)
ks.test(x, "pnorm")
## flourish
describe(testdf.v26$flourish)
x <- rnorm(testdf.v26$flourish)
ks.test(x, "pnorm")
## persist
describe(testdf.v26$persist)
x <- rnorm(testdf.v26$persist)
ks.test(x, "pnorm")
## talk
table(testdf.v26$talk)

wilcox.test(testdf.v26B$aaq_tot, traindf.v28B$aaq_tot) # W = 16019656, p-value = 0.7929
wilcox.test(testdf.v26B$flourish, traindf.v28B$flourish) # W = 16134998, p-value = 0.6892
wilcox.test(testdf.v26B$persist, traindf.v28B$persist) # W = 15987918, p-value = 0.6259

set.seed(1000)
tt_compare <- rbind(table(testdf.v26B$talk), table(traindf.v28B$talk))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 0.1896632, p = 0.663
...
```{r}
# race
tt_compare <- rbind(table(testdf.v26B$activ_no), table(traindf.v28B$activ_no))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 1.628122, p = 0.202
# dx_mh
tt_compare <- rbind(table(testdf.v26B$dx_mh), table(traindf.v28B$dx_mh))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 0.59196, p = 0.442
# ed_any
tt_compare <- rbind(table(testdf.v26B$ed_any), table(traindf.v28B$ed_any))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 0.05235889, p = 0.819
# gender_tgd
tt_compare <- rbind(table(testdf.v26B$gender_tgd), table(traindf.v28B$gender_tgd))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 0.06002178, p = 0.806
# international
tt_compare <- rbind(table(testdf.v26B$international), table(traindf.v28B$international))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 1.093304, p = 0.296
# meds_any
tt_compare <- rbind(table(testdf.v26B$meds_any), table(traindf.v28B$meds_any))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 0.006302216, p = 0.937
# race
tt_compare <- rbind(table(testdf.v26B$race), table(traindf.v28B$race))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 1.517476, p = 0.218
# race
tt_compare <- rbind(table(testdf.v26B$activ_no), table(traindf.v28B$activ_no))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 1.628122, p = 0.202
# school2_4yr
tt_compare <- rbind(table(testdf.v26B$school2_4yr), table(traindf.v28B$school2_4yr))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 0.5745218, p = 0.448
# school2_cc
tt_compare <- rbind(table(testdf.v26B$school2_cc), table(traindf.v28B$school2_cc))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 0.03541341, p = 0.851
# school2_ad
tt_compare <- rbind(table(testdf.v26B$school2_ad), table(traindf.v28B$school2_ad))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 3.658646, p = 0.0558
# sib_freq
tt_compare <- rbind(table(testdf.v26B$sib_freq), table(traindf.v28B$sib_freq))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 1.371594, p = 0.242
# undercls
tt_compare <- rbind(table(testdf.v26B$undercls), table(traindf.v28B$undercls))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 0.3610179, p = 0.548
# sexual
tt_compare <- rbind(table(testdf.v26B$sexual), table(traindf.v28B$sexual))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 0.1896632, p = 0.663
```

```{r}
# premotivation 18 v. 20

describe(test18.v26$age)
describe(test20.v26$age)
wilcox.test(test18.v26$age, test20.v26$age) 
set.seed(1000)
ks.test(rnorm(test18.v26$age), "pnorm")
ks.test(rnorm(test20.v26$age), "pnorm")


table(test18.v26B$sui_idea)


describe(test18.v26$finpast)
describe(test20.v26$finpast)
wilcox.test(test18.v26$finpast, test20.v26$finpast)
set.seed(1000)
ks.test(rnorm(test18.v26$finpast), "pnorm")
ks.test(rnorm(test20.v26$finpast), "pnorm")


describe(test18.v26$religios)
describe(test20.v26$religios)
set.seed(1000)
x <- rnorm(test18.v26$religios)
ks.test(x, "pnorm")
y <- rnorm(test20.v26$religios)
ks.test(y, "pnorm")
wilcox.test(test18.v26$religios, test20.v26$religios)


describe(test18.v26$satisfied_overall)
describe(test20.v26$satisfied_overall)
set.seed(1000)
x <- rnorm(test18.v26$satisfied_overall)
ks.test(x, "pnorm")
y <- rnorm(test20.v26$satisfied_overall)
ks.test(y, "pnorm")
wilcox.test(test18.v26$satisfied_overall, test20.v26$satisfied_overall)

# activ_no
table(test18.v26$activ_no)
table(test20.v26$activ_no)
tt_compare <- rbind(table(test18.v26$activ_no), table(test20.v26$activ_no))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F)
...
tt_compare <- rbind(table(test18.v26$dx_mh), table(test20.v26$dx_mh))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F)

# ed_any
table(test18.v26$ed_any)
table(test20.v26$ed_any)
tt_compare <- rbind(table(test18.v26$ed_any), table(test20.v26$ed_any))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F)
...
table(test18.v26$activ_no)
table(test20.v26$activ_no)
tt_compare <- rbind(table(test18.v26$gender_tgd), table(test20.v26$gender_tgd))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F)

# international
table(test18.v26$international)
table(test20.v26$international)
tt_compare <- rbind(table(test18.v26$international), table(test20.v26$international))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) # statistic = 1.093304, p = 0.296

# meds_any
table(test18.v26$meds_any)
table(test20.v26$meds_any)
tt_compare <- rbind(table(test18.v26$meds_any), table(test20.v26$meds_any))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) 
...
tt_compare <- rbind(table(test18.v26$race), table(test20.v26$race))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F)
...
# school2_4yr
table(test18.v26$school2_4yr)
table(test20.v26$school2_4yr)
tt_compare <- rbind(table(test18.v26$school2_4yr), table(test20.v26$school2_4yr))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F)

# school2_cc
table(test18.v26$school2_cc)
table(test20.v26$school2_cc)
tt_compare <- rbind(table(test18.v26$school2_cc), table(test20.v26$school2_cc))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F)

# school2_ad
table(test18.v26$school2_ad)
table(test20.v26$school2_ad)
tt_compare <- rbind(table(test18.v26$school2_ad), table(test20.v26$school2_ad))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) 

# sib_freq
table(test18.v26$sib_freq)
table(test20.v26$sib_freq)
tt_compare <- rbind(table(test18.v26$sib_freq), table(test20.v26$sib_freq))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) 

# undercls
table(test18.v26$undercls)
table(test20.v26$undercls)
tt_compare <- rbind(table(test18.v26$undercls), table(test20.v26$undercls))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F)
...
tt_compare <- rbind(table(test18.v26$sexual), table(test20.v26$sexual))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) 
```
...
```{r}
#life event 18 v. 20 comparison

## gpa_sr
describe(test18.v26$gpa_sr)
describe(test20.v26$gpa_sr)
wilcox.test(test18.v26$gpa_sr, test20.v26$gpa_sr)

## assault
table(test18.v26$assault)
table(test20.v26$assault)
tt_compare <- rbind(table(test18.v26$assault), table(test20.v26$assault))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) 

## psyhx
table(test18.v26$psyhx)
table(test20.v26$psyhx)
tt_compare <- rbind(table(test18.v26$psyhx), table(test20.v26$psyhx))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) 

## fincur
table(test18.v26$fincur)
table(test20.v26$fincur)
tt_compare <- rbind(table(test18.v26$fincur), table(test20.v26$fincur))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) 

## drugs_yn
table(test18.v26$drugs_yn)
table(test20.v26$drugs_yn)
tt_compare <- rbind(table(test18.v26$drugs_yn), table(test20.v26$drugs_yn))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) 

## drug_mar
table(test18.v26$drug_mar)
table(test20.v26$drug_mar)
tt_compare <- rbind(table(test18.v26$drug_mar), table(test20.v26$drug_mar))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) 
...
## gpa_sr
describe(test18.v26$anx_score)
describe(test20.v26$anx_score)
wilcox.test(test18.v26$anx_score, test20.v26$anx_score)

## dep_impa
describe(test18.v26$dep_impa)
describe(test20.v26$dep_impa)
wilcox.test(test18.v26$dep_impa, test20.v26$dep_impa)

## percneed
describe(test18.v26$percneed)
describe(test20.v26$percneed)
wilcox.test(test18.v26$percneed, test20.v26$percneed)

## deprawsc
describe(test18.v26$deprawsc)
describe(test20.v26$deprawsc)
wilcox.test(test18.v26$deprawsc, test20.v26$deprawsc)
```
...
# aaq_tot
describe(test18.v26$aaq_tot)
describe(test20.v26$aaq_tot)
wilcox.test(test18.v26$aaq_tot, test20.v26$aaq_tot)

## flourish
describe(test18.v26$flourish)
describe(test20.v26$flourish)
wilcox.test(test18.v26$flourish, test20.v26$flourish)

## persist
describe(test18.v26$persist)
describe(test20.v26$persist)
wilcox.test(test18.v26$persist, test20.v26$persist)

## talk
table(testdf.v26$talk)
table(test18.v26$talk)
table(test20.v26$talk)
set.seed(1000)
x <- rnorm(test18.v26$talk)
ks.test(x, "pnorm")
x <- rnorm(test20.v26$talk)
ks.test(x, "pnorm")

tt_compare <- rbind(table(test18.v26$talk), table(test20.v26$talk))
tt_compare <- as.matrix(tt_compare)
chisq_test(tt_compare, correct=F) 
