...
#IMPORT file
# data.raw20 <- read_excel("~/Desktop/Sisler_dissertation_HMS1819_audit.xlsx",
#                        range=cell_cols(1:1820), col_types = "text")
# 
# save("data.raw20", file="~/Desktop/Sisler_dissertation_HMS1819_audit.RData")
load("~/Desktop/Sisler_dissertation_HMS1819_audit.RData")
 # source("dissertation_fx.R")
   
data.v1 <- data.raw18 %>%
  mutate(age = as.numeric(age)) %>%
  filter(age < 26 & age >= 20) %>%
  select(-c(
