...
# training v. testing
wilcox.test(testdf.v26B$age,traindf.v28B$age, alternative = "two.sided") # W = 18250760, p-value = 0.7409
wilcox.test(testdf.v26B$si_type,traindf.v28B$si_type, alternative = "two.sided") # W = 18433896, p-value = 0.3097
wilcox.test(testdf.v26B$gender_tgd,traindf.v28B$gender_tgd, alternative = "two.sided") # W = 18231346, p-value = 0.1632
wilcox.test(testdf.v26B$sexual, traindf.v28B$sexual, alternative = "two.sided") # W = 18089541, p-value = 0.003971
wilcox.test(testdf.v26B$race, traindf.v28B$race, alternative = "two.sided") # W = 18042672, p-value = 0.09686
wilcox.test(testdf.v26B$dx_mh, traindf.v28B$dx_mh, alternative = "two.sided") # W = 18575966, p-value = 0.1063

# 18-19 v. 20-25
wilcox.test(test20.v26B$age, test18.v26B$age, alternative = "two.sided") # W = 8970195, p-value < 2.2e-16 ***
wilcox.test(test20.v26B$si_type, test18.v26B$si_type, alternative = "two.sided") # W = 4303474, p-value = 2.444e-05 ***
wilcox.test(test20.v26B$gender_tgd, test18.v26B$gender_tgd, alternative = "two.sided") # W = 4433091, p-value = 0.01156
wilcox.test(test20.v26B$sexual, test18.v26B$sexual, alternative = "two.sided") # W = 4241008, p-value = 1.849e-06 ***
wilcox.test(test20.v26B$race, test18.v26B$race, alternative = "two.sided") # W = 4530184, p-value = 0.441
wilcox.test(test20.v26B$dx_mh, test18.v26B$dx_mh, alternative = "two.sided") # W = 4596954, p-value = 0.05688
``` 
