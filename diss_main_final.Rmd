...
```{r train prem_pca}
# Define diathesis vars for correlation matrix
traindf_prem <- traindf.v15 %>% select(sexual, gender_tgd, sib_freq, race, ed_any, dx_mh, international,
                                       meds_any, ther, religios, school2_type, residenc, satisfied_overall, undercls)
...
results_prem <- dummy_cols(traindf_prem, select_columns = c("sexual", "gender_tgd", "sib_freq",
...
```{r train clm_prem}
clm_prem <- traindf.v15 %>% select(si_type, sexual, gender_tgd, sib_freq, race, ed_any, 
                                   dx_mh, international, religios, school2_type, residenc, 
                                   meds_any, ther, satisfied_overall, undercls)
clm_prem <- na.omit(clm_prem)

# run regression
clm_prem <- glm(si_type ~ sexual + gender_tgd + sib_freq + race + ed_any + dx_mh + undercls +
...
# training v. testing
wilcox.test(testdf.v26B$age,traindf.v28B$age, alternative = "two.sided") # W = 18919714, p-value = 0.03372
wilcox.test(testdf.v26B$si_type,traindf.v28B$si_type, alternative = "two.sided") # W = 18414990, p-value = 0.4177
wilcox.test(testdf.v26B$gender_tgd,traindf.v28B$gender_tgd, alternative = "two.sided") # W = 18438750, p-value = 0.2175
wilcox.test(testdf.v26B$sexual, traindf.v28B$sexual, alternative = "two.sided") # W = 18258125, p-value = 0.07822
wilcox.test(testdf.v26B$race, traindf.v28B$race, alternative = "two.sided") # W = 18642436, p-value = 0.43
wilcox.test(testdf.v26B$dx_mh, traindf.v28B$dx_mh, alternative = "two.sided") # W = 18753395, p-value = 0.1419

# 18-19 v. 20-25
wilcox.test(test20.v26B$age, test18.v26B$age, alternative = "two.sided") # W = 9100224, p-value < 2.2e-16 ***
wilcox.test(test20.v26B$si_type, test18.v26B$si_type, alternative = "two.sided") # W = 4386130, p-value = 0.0001562 ***
wilcox.test(test20.v26B$gender_tgd, test18.v26B$gender_tgd, alternative = "two.sided") # W = 4515383, p-value = 0.09986
wilcox.test(test20.v26B$sexual, test18.v26B$sexual, alternative = "two.sided") #  W = 4313015, p-value = 4.981e-06 ***
wilcox.test(test20.v26B$race, test18.v26B$race, alternative = "two.sided") # W = 4578474, p-value = 0.6357
wilcox.test(test20.v26B$dx_mh, test18.v26B$dx_mh, alternative = "two.sided") # W = 4579225, p-value = 0.6254
``` 
