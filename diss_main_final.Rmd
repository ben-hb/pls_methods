...
results_tr_com1 <- dummy_cols(traindf_sem1, select_columns = c("si_type", "race"),
                         remove_first_dummy = TRUE, remove_selected_columns = TRUE)
...
## Dummy col SEM w/ continuous
results_test_com18 <- dummy_cols(test18_sem, select_columns = c("si_type", "race"),
                         remove_first_dummy = TRUE, remove_selected_columns = TRUE)
...
## Dummy col SEM w/ continuous
results_test_com20 <- dummy_cols(test20_sem, select_columns = c("si_type", "race"),
                         remove_first_dummy = TRUE, remove_selected_columns = TRUE)
