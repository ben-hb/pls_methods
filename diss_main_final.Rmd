...
traindf_prem <- traindf.v19 %>% select(si_type, age, sexual, gender_tgd, sib_freq, race, ed_any, dx_mh,
                                       meds_any, ther, religios, school2_type, fincur, ins_no, residenc,
...
traindf_prem <- traindf.v19 %>% select(age, sexual, gender_tgd, sib_freq, race, ed_any, dx_mh,
                                       meds_any, ther, religios, school2_type, ins_no, residenc,
...
clm_prem <- traindf.v19 %>% select(si_type, age, sexual, gender_tgd, sib_freq, race, ed_any, dx_mh, 
                                 religios, school2_type, ins_no, residenc, meds_any, ther,
                                 gpa_sr, assault, drugs_yn, drug_mar, psyhx, fincur, satisfied_overall)
clm_prem <- na.omit(clm_prem)

# run regression
clm_prem <- glm(si_type ~ age + sexual + gender_tgd + sib_freq + race + ed_any + dx_mh +
                religios +  school2_type + ins_no + residenc + gpa_sr + assault +
                drugs_yn + drug_mar + psyhx + meds_any + ther + fincur + satisfied_overall,
              data = clm_prem)
summary(clm_prem)
