...
traindf.v26 <- traindf.v26 %>% 
  ...
  mutate(inf = case_when(inf_1 == 1 ~ 2,
                         inf_2 == 1 ~ 3,
                         inf_3 == 1 ~ 4,
                         inf_4 == 1 ~ 5,
                         inf_5 == 1 ~ 6,
...
results_tr_df <- as.data.frame(results_corr)

is.atomic(results_tr_df)
is.recursive(results_tr_df)

# fit_tr <- cfa(SI_model_tr, data = results_tr_df, 
#               ordered = "si_type_2", "si_type_3", "si_type_4",
#               "age_19", "age_20", "age_21", "age_22", "age_23", "age_24", "age_25", 
#               "meds_count_1", "meds_count_2", "meds_count_3")

fit_train <- sem(SI_model_tr, data=results_tr_df, 
                 ordered = "si_type_2", "si_type_3", "si_type_4",
                 "age_19", "age_20", "age_21", "age_22", "age_23", "age_24", "age_25", 
                 "meds_count_1", "meds_count_2", "meds_count_3")
