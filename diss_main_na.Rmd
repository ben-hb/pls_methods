...
traindf.v26 <- traindf.v26 %>%
  mutate(flourish_dum = case_when(is.na(flourish_dum) ~ 0,
                                  flourish > 50 ~ 5,
                                  flourish > 40 ~ 4,
                                  flourish > 30 ~ 3,
                                  flourish > 20 ~ 2,
...
```{r}
# zeroinfl <- function(si_type, results_tr_sem, na.action = TRUE
#                      dist = c("binomial"),
#                      link = c("logit"))
```
...
SI_model_tr <- '
                # measurement model
                  ...
                  dia_sem =~ age_19 + age_20 + age_21 + age_22 + age_23 + age_24 + age_25 +
                             ...
                             ed_any_2 + ed_any_NA +
                             dx_mh_1
                             meds_count_1 + meds_count_2 + meds_count_3 + meds_count_4
                                meds_count_5 + meds_count_6
                  ...
                  le_sem =~  ins_cover_2 + ins_cover_3 +
                             gpa_sr_1 + gpa_sr_2 + gpa_sr_3 + gpa_sr_4 +
                             binge_1 +
                             psyhx_1 + psyhx_NA +
                             fincur_1 + fincur_2 + fincur_3 + 
                             drugs_yn_1 +
                             assault_1

                  def_sem =~ aca_impa_2 + aca_impa_3 + aca_impa_4 + 
                             dep_type_2 + dep_type_3 + dep_type_4 + dep_type_5 +
                             anx_type_2 + anx_type_3 + anx_type_4

                  tsm_sem =~ persist_2 + persist_3 + persist_4 + persist_5 + persist_6 +
                  ...
                  mm_sem =~  inf_1 + inf_NA +
                             flourish_dum_2 + flourish_dum_3 + + flourish_dum43 + flourish_dum_5 + flourish_dum_NA +
               ...
               # covars
                  ...
                  dx_mh_1 ~~ meds_count_4
                  dx_mh_1 ~~ meds_count_5
                  dx_mh_1 ~~ meds_count_6  '
```
