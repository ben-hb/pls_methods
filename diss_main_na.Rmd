...
var_names <- c(
  # diathesis
  "undercls", "sexual", "gender_tgd", "sib_freq", "ed_any", "dx_mh", "meds_count",
  # environment
...
results_tr_com1 <- dummy_cols(traindf_sem1, select_columns = c("si_type", "age", "sexual", "school2_type", "residenc"),
                         remove_first_dummy = TRUE, remove_selected_columns = TRUE)
...
SI_model_tr1 <- '
                # measurement model
                  ...
                  prem  =~ undercls + sexual_2 + sexual_3 + gender_tgd + sib_freq + 
                           ...
                           residenc_2 + residenc_3 + residenc_4 + military
