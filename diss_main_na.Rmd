...
results_tsm <- dummy_cols(traindf_tsm, select_columns = c("persist", "anx_type", "dep_secret", "achieve4", "aaq_tot"),
                         remove_first_dummy = TRUE)
...
## CLM TSM
```{r CLM TSM}
clm_tsm <- traindf.v23 %>% select(si_type, persist, anx_type, dep_secret, aaq_tot)

clm_tsm <- NA_preproc(clm_tsm)
clm_tsm <- as.data.frame(clm_tsm)

clm_tsm <- clm(si_type ~ persist + anx_type + dep_secret + aaq_tot,
               data = clm_tsm) 
...
traindf.v26$stig_pcv_2 <- as.logical(traindf.v26$stig_pcv_2)
traindf.v26$stig_pcv_3 <- as.logical(traindf.v26$stig_pcv_3)
traindf.v26$stig_per_2 <- as.logical(traindf.v26$stig_per_2)
traindf.v26$stig_per_3 <- as.logical(traindf.v26$stig_per_3)
...
# combine scales
traindf.v26 <- traindf.v26 %>%
  mutate(mh_stigma = case_when(stig_pcv2b == 1 ~ 1,
                               stig_pcv3b == 1 ~ 1,
                               stig_per2b == 1 ~ 1,
                               stig_per_3b == 1 ~ 1,
                               stig_pcv_2b == 0 ~ 0,
