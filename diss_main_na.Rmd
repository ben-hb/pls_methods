...
SI_model_tr <- '
                # measurement model
                  ...
                  dia_sem =~ age_19 + age_20 + age_21 + age_22 + age_23 + age_24 + age_25 +
                             sexual_2 + sexual_3 + gender_tgd_2 + sib_freq_1 + sib_freq_2 +  
                  ...
                  le_sem =~  ins_cover_2 + ins_cover_3 + gpa_sr_1 + gpa_sr_2 + 
                             gpa_sr_3 + gpa_sr_4 +  binge_1 + psyhx_1 + fincur_1 + 
                             drugs_yn_1 + drug_mar_1 + assault_1

                  def_sem =~ aca_impa_2 + aca_impa_3 + aca_impa_4 + 
                             dep_type_2 + dep_type_3 + dep_type_4 + dep_type_5 +
                             anx_type_2 + anx_type_3 + anx_type_4

                  tsm_sem =~ persist_2 + persist_3 + persist_4 + persist_5 + persist_6 + aaq_dum_2
...
results_tr_sem2 <- as.data.frame(results_tr_sem)
...
fit_train <- sem(SI_model_tr, data=results_tr_sem2,
                 ...
                 "satisfied_overall_3", "satisfied_overall_4", "satisfied_overall_5", "satisfied_overall_6",
                 ...
                 "persist_4", "persist_5", "persist_6", "dep_impa_2",
                 "dep_impa_3", "dep_impa_4", "gad7_impa_2", "gad7_impa_3",
                 "gad7_impa_4", "flourish_dum_2", "flourish_dum_3", "flourish_dum_4",
                 "flourish_dum_5", "belong1_2", "belong1_3", "belong1_4",
                 "belong1_5", "belong1_6"))
