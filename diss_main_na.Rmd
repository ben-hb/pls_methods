...
sub18.v11 <- sub18.v11 %>%
  ...
  mutate(ed_any = case_when(ed_any == 1 ~ 1,
                            ed_any == 0 ~ 0))
sub18.v11$ed_any <- as.logical(sub18.v11$ed_any)

table(sub18.v11$ed_any, useNA = "always")
jarque.bera.test(sub18.v11$ed_any)
```
...
to see what is associated (i.e. the count is meant to find the common meds in suicidality)
```{r med_count}
sub18.v11$meds_1 <- as.numeric(sub18.v11$meds_1)
sub18.v11$meds_2 <- as.numeric(sub18.v11$meds_2)
sub18.v11$meds_3 <- as.numeric(sub18.v11$meds_3)
sub18.v11$meds_4 <- as.numeric(sub18.v11$meds_4)
sub18.v11$meds_5 <- as.numeric(sub18.v11$meds_5)
sub18.v11$meds_6 <- as.numeric(sub18.v11$meds_6)
sub18.v11$meds_7 <- as.numeric(sub18.v11$meds_7)
sub18.v11$meds_8 <- as.numeric(sub18.v11$meds_8)

sub18.v11$meds_1[is.na(sub18.v11$meds_1)] <- 0
sub18.v11$meds_2[is.na(sub18.v11$meds_2)] <- 0
sub18.v11$meds_3[is.na(sub18.v11$meds_3)] <- 0
sub18.v11$meds_4[is.na(sub18.v11$meds_4)] <- 0
sub18.v11$meds_5[is.na(sub18.v11$meds_5)] <- 0
sub18.v11$meds_6[is.na(sub18.v11$meds_6)] <- 0
sub18.v11$meds_7[is.na(sub18.v11$meds_7)] <- 0
...
sub18.v11 <- sub18.v11 %>%
  ...
  mutate(meds_count = case_when(meds_count == 0 ~ 0,
                                ...
                                meds_count == 5 ~ 3,
                                meds_count == 6 ~ 3))
sub18.v11$meds_count <- as.numeric(sub18.v11$meds_count)

table(sub18.v11$meds_count, useNA = "always")  # check output
hist(sub18.v11$meds_count)
jarque.bera.test(sub18.v11$meds_count)
```
...
sub18.v13 <- sub18.v11 %>%
  filter(!is.na(religios))
sub18.v13$religios <- as.numeric(sub18.v13$religios)

table(sub18.v13$religios, useNA = "always")       # Check output
jarque.bera.test(sub18.v13$religios)
```
...
table(sub18.v13$residenc, useNA = "always")
jarque.bera.test(sub18.v13$residenc)
```
...
sub18.v14 <- sub18.v13 %>%
  mutate(international = case_when(international == 1 ~ 1,
                                   international == 0 ~ 0)) %>%
  filter(!is.na(international))
sub18.v14$international <- as.logical(sub18.v14$international)

table(sub18.v14$international, useNA = "always")
```

## Activity Involvement
```{r Activities}
# set all NAs in actvities equal to 0
sub18.v14$activ_ac[is.na(sub18.v14$activ_ac)] <- 0
sub18.v14$activ_athc[is.na(sub18.v14$activ_athc)] <- 0
sub18.v14$activ_athv[is.na(sub18.v14$activ_athv)] <- 0
sub18.v14$activ_athi[is.na(sub18.v14$activ_athi)] <- 0
sub18.v14$activ_cs[is.na(sub18.v14$activ_cs)] <- 0
sub18.v14$activ_cu[is.na(sub18.v14$activ_cu)] <- 0
sub18.v14$activ_da[is.na(sub18.v14$activ_da)] <- 0
sub18.v14$activ_fs[is.na(sub18.v14$activ_fs)] <- 0
sub18.v14$activ_gs[is.na(sub18.v14$activ_gs)] <- 0
sub18.v14$activ_gov[is.na(sub18.v14$activ_gov)] <- 0
sub18.v14$activ_mp[is.na(sub18.v14$activ_md)] <- 0
sub18.v14$activ_md[is.na(sub18.v14$activ_none)] <- 0
sub18.v14$activ_soc[is.na(sub18.v14$activ_soc)] <- 0
sub18.v14$activ_rel[is.na(sub18.v14$activ_rel)] <- 0
sub18.v14$activ_art[is.na(sub18.v14$activ_art)] <- 0
sub18.v14$activ_other[is.na(sub18.v14$activ_other)] <- 0
...
sub18.v14 <- sub18.v14 %>% 
  mutate(activ_yn = case_when(activ_none == 1 ~ 0,
                              ...
                              activ_other == 1 ~ 1)) %>%
  filter(!is.na(activ_yn))
sub18.v14$activ_yn <- as.logical(sub18.v14$activ_yn)

table(sub18.v14$activ_yn, useNA = "always")     # tabulate and check output
jarque.bera.test(sub18.v14$activ_yn)
```
...
# Binary variable for school type
table(sub18.v14$school2_4yr)
table(sub18.v14$school2_cc)
table(sub18.v14$school2_ad)
...
sub18.v14 <- sub18.v14 %>%
  mutate(school2_type = case_when(school2_4yr == TRUE ~ 1,
                                  ...
                                  school2_ad == TRUE ~ 3)) %>%
  filter(!is.na(school2_type))
sub18.v14$school2_type <- as.factor(sub18.v14$school2_type)

table(sub18.v14$school2_type, useNA = "always") # check output
```
...
sub18.v16 <- sub18.v14 %>% 
  mutate(ins_cover = case_when((ins_1 == 1 | ins_mh == 4 | ins_mh == 5 | ins_ade == 3) ~ 0,   # inadequate coverage
                               (ins_1 == 0 | ins_mh == 1 | ins_mh == 2 | ins_ade == 2) ~ 1)) %>% # adequate MH coverage
  filter(!is.na(ins_cover))   
sub18.v16$ins_cover <- as.logical(sub18.v16$ins_cover)
table(sub18.v16$ins_cover, useNA = "always")   # check output

#sub18.v16 = sub18set(sub18.v16, select= -c(ins_1, ins_mh, ins_ade, ins_inade)) # clean up var
```
...
```{r drugs_yn}
## add summary of each
sub18.v16$drug_coc[is.na(sub18.v16$drug_coc)] <- 0
sub18.v16$drug_her[is.na(sub18.v16$drug_her)] <- 0
sub18.v16$drug_met[is.na(sub18.v16$drug_met)] <- 0
sub18.v16$drug_stim[is.na(sub18.v16$drug_stim)] <- 0
sub18.v16$drug_ect[is.na(sub18.v16$drug_ect)] <- 0
sub18.v16$drug_opi[is.na(sub18.v16$drug_opi)] <- 0
sub18.v16$drug_other[is.na(sub18.v16$drug_other)] <- 0

table(sub18.v16$drug_coc)
table(sub18.v16$drug_her)  # too small
table(sub18.v16$drug_met)  # too small
table(sub18.v16$drug_stim)
table(sub18.v16$drug_ect)  # too small
table(sub18.v16$drug_opi)   # too small
table(sub18.v16$drug_other)  # too vague, small
...
sub18.v16 <- sub18.v16 %>%
  mutate(drugs_yn = case_when(drug_coc == 1 ~ 1,
                              ...
                              drug_opi == 1 ~ 1,
                              drug_other == 1 ~ 1))
sub18.v16$drugs_yn[is.na(sub18.v16$drugs_yn)] <- 0
sub18.v16$drugs_yn <- as.logical(sub18.v16$drugs_yn)

table(sub18.v16$drugs_yn, useNA = "always")
```

## Marijuana use
```{r sub1818 drug_mar}
sub18.v16$drug_mar[is.na(sub18.v16$drug_mar)] <- 0
table(sub18.v16$drug_mar)  
...
sub18.v16$drug_mar <- as.logical(sub18.v16$drug_mar)

table(sub18.v16$drug_mar, useNA = "always")
```
...
sub18.v16 <- sub18.v16 %>%
  ...
  mutate(fincur = case_when(fincur == 3 ~ 0,  # sometimes
                            ...
                            fincur == 1 ~ 1,  # always or often stressful
                            fincur == 2 ~ 1))
sub18.v16$fincur <- as.logical(sub18.v16$fincur)

table(sub18.v16$fincur, useNA = "always")
```

## Abuse or assault, in the last year only
```{r assault}
table(sub18.v16$abuse_life)
table(sub18.v16$abuse_recent)
...
sub18.v17 <- sub18.v16 %>%
  mutate(abuse_year = case_when(abuse_recent == 1 ~ 1,
                                ...
                                abuse_life == 0 ~ 0,
                                is.na(abuse_life) ~ 0))
table(sub18.v17$abuse_year)   # check output
...
sub18.v17 <- sub18.v17 %>%
  ...
  mutate(assault = case_when(assault == 1 ~ 1,
                             assault == 0 ~ 0,
                             is.na(assault) ~ 0))
sub18.v17$assault <- as.logical(sub18.v17$assault)

# tabulate and check output
table(sub18.v17$assault, useNA = "always") 
```

## Binging frequency
```{r binge_fr}
# set all binge_fr values equal to 0
sub18.v17$binge_fr_f[is.na(sub18.v17$binge_fr_f)] <- 0
sub18.v17$binge_fr_m[is.na(sub18.v17$binge_fr_m)] <- 0
sub18.v17$binge_fr_o[is.na(sub18.v17$binge_fr_o)] <- 0

# create one binge var
sub18.v18 <- sub18.v17 %>% 
  mutate(binge_fr = as.numeric(binge_fr_f) + as.numeric(binge_fr_m) + as.numeric(binge_fr_o))
table(sub18.v18$binge_fr)

sub18.v18 <- sub18.v18 %>%
  mutate(binge = case_when(binge_fr >= 4 ~ 1,
                           binge_fr < 4 ~ 0)) %>%
  filter(!is.na(binge))
sub18.v18$binge <-as.logical(sub18.v18$binge)

table(sub18.v18$binge, useNA = "always") # check output
```
...
sub18.v18 <- sub18.v18 %>% 
  mutate(psyhx = case_when((prov_pes == 1 | prov_inp == 1 | prov_par == 1) ~ 1, 
                           ...
                           ther_ever == 0 ~ 0)) %>%
  filter(!is.na(psyhx))
sub18.v18$psyhx <- as.logical(sub18.v18$psyhx)

table(sub18.v18$psyhx, useNA = "always")   # check output
```
...
sub18.v18 <- sub18.v18 %>%
  mutate(gpa_sr = case_when(gpa_sr == 0 ~ 1,   # A+
                            ...
                            gpa_sr == 10 ~ 5,  # Don't know
                            is.na(gpa_sr) ~ 5))
sub18.v18$gpa_sr <- as.numeric(sub18.v18$gpa_sr)

table(sub18.v18$gpa_sr, useNA = "always")
```

## PHQ risk/severity
```{r deprawsc}
table(sub18.v18$deprawsc)
sub18.v18$deprawsc <- as.numeric(sub18.v18$deprawsc)
...
sub18.v20 <- sub18.v18 %>%
  ...
  mutate(dep_na = case_when(is.na(deprawsc) ~ 1,
                            !is.na(deprawsc) ~ 0))
sub18.v20$deprawsc <- as.numeric(sub18.v20$deprawsc)

# Check outputs
table(sub18.v20$dep_none)
table(sub18.v20$dep_mild)
table(sub18.v20$dep_mod)
table(sub18.v20$dep_modsev)
table(sub18.v20$dep_sev)
table(sub18.v20$dep_na)
...
table(sub18.v20$dep_type, useNA = "always")
```

## GAD7 total
```{r anx_score}
sub18.v20$anx_score <- as.numeric(sub18.v20$anx_score)
...
table(sub18.v20$anx_type, useNA = "always") # check output
```
...
sub18.v20 <- sub18.v20 %>%
  ...
  mutate(aca_impa = case_when(aca_impa == 1 ~ 1,
                              ...
                              aca_impa == 3 ~ 3,
                              aca_impa == 4 ~ 4)) 
sub18.v20$aca_impa <- as.numeric(sub18.v20$aca_impa)

table(sub18.v20$aca_impa, useNA = "always")
```
...
table(sub18.v22$aaq_tot)

#  for loop for predictive cutoff point needed
 rs_df <- data.frame("cutoff" = c(), "rs" = c())
 for (i in 8:48) {
   aaq_bin <- ifelse(sub18.v22$aaq_tot >= i, TRUE, FALSE)
   model = lm(sub18.v22$sui_idea ~ aaq_bin)
   rs_df <- rbind(rs_df, c(i, summary(model)$r.squared))
...
# deem 'rs_df_arranged[1,1]' as SI cutoff
 sub18.v22 <- sub18.v22 %>%
   ...
   mutate(aaq_dum = case_when(aaq_dum == 1 ~ 1,
                              aaq_dum == 0 ~ 0)) %>%
   filter(!is.na(aaq_dum))
sub18.v22$aaq_dum <- as.logical(sub18.v22$aaq_dum)

table(sub18.v22$aaq_dum, useNA = "always")
```
...
sub18.v22 <- sub18.v22 %>%
  mutate(persist = case_when(persist == 1 ~ 1,   # confident
                             ...
                             persist == 5 ~ 5, 
                             persist == 6 ~ 6))  # not
sub18.v22$persist <- as.numeric(sub18.v22$persist)

table(sub18.v22$persist, useNA = "always") # check output
```
...
sub18.v24 <- sub18.v22 %>%
  mutate(dep_impa = case_when(dep_impa == 1 ~ 1,
                              ...
                              dep_impa == 4 ~ 4)) %>%
  filter(!is.na(dep_impa))
sub18.v24$dep_impa <- as.numeric(sub18.v24$dep_impa)

table(sub18.v24$dep_impa, useNA = "always")
```
...
sub18.v24 <- sub18.v24 %>%
  mutate(gad7_impa = case_when(gad7_impa == 1 ~ 1,
                               ...
                               gad7_impa == 4 ~ 4)) %>%
  filter(!is.na(gad7_impa))
sub18.v24$gad7_impa <- as.numeric(sub18.v24$gad7_impa)

table(sub18.v24$gad7_impa, useNA = "always")
```
...
sub18.v24 <- sub18.v24 %>%
  mutate(percneed_cur = case_when(percneed_cur == 1 ~ 1,
                                 ...
                                 percneed_cur == 5 ~ 5,
                                 percneed_cur == 6 ~ 6))
sub18.v24$percneed_cur <- as.numeric(sub18.v24$percneed_cur)
table(sub18.v24$percneed_cur, useNA = "always")
```
...
sub18.v26 <- sub18.v24 %>%
  mutate(belong1 = case_when(belong1 == 1 ~ 1,
                             ...
                             belong1 == 6 ~ 6)) %>%
  filter(!is.na(belong1))
table(sub18.v26$belong1, useNA = "always")
sub18.v26$belong1 <- as.numeric(sub18.v26$belong1)
summary(sub18.v26$belong1)
```
...
sub18.v26 <- sub18.v26 %>%
  mutate(satisfied_overall = case_when(satisfied_overall == 1 ~ 1,
                                       ...
                                       satisfied_overall == 6 ~ 6)) %>% 
  filter(!is.na(satisfied_overall))
sub18.v26$satisfied_overall <- as.numeric(sub18.v26$satisfied_overall)

table(sub18.v26$satisfied_overall, useNA = "always")
```

## Flourishing Scale
```{r flourish}
sub18.v26$flourish <- as.numeric(sub18.v26$flourish)
table(sub18.v26$flourish)


#  for loop for predictive cutoff point needed
rs_df <- data.frame("cutoff" = c(), "rs" = c())
for (i in 9:55) {
  flourish_bin <- ifelse(sub18.v26$flourish >= i, TRUE, FALSE)
  model = lm(sub18.v26$sui_idea ~ flourish_bin)
  rs_df <- rbind(rs_df, c(i, summary(model)$r.squared))
...
sub18.v26 <- sub18.v26 %>%
  mutate(flourish_dum = case_when(flourish > 50 ~ 5,
                                  ...
                                  flourish < 14 ~ 1)) %>%
  filter(!is.na(flourish_dum))
sub18.v26$flourish_dum <- as.numeric(sub18.v26$flourish_dum)

table(sub18.v26$flourish_dum, useNA = "always")
```

## Informal Mental Health Support
```{r inf}
sub18.v26$inf_1[is.na(sub18.v26$inf_1)] <- 0
sub18.v26$inf_2[is.na(sub18.v26$inf_2)] <- 0
sub18.v26$inf_3[is.na(sub18.v26$inf_3)] <- 0
sub18.v26$inf_4[is.na(sub18.v26$inf_4)] <- 0
sub18.v26$inf_5[is.na(sub18.v26$inf_5)] <- 0
sub18.v26$inf_6[is.na(sub18.v26$inf_6)] <- 0
sub18.v26$inf_7[is.na(sub18.v26$inf_7)] <- 0
...
sub18.v26 <- sub18.v26 %>% 
  ...
  mutate(inf = case_when(inf_8 == 1 ~ 1,
                         ...
                         inf_7 == 1 ~ 0)) %>%
  filter(!is.na(inf))
sub18.v26$inf <- as.logical(sub18.v26$inf)

table(sub18.v26$inf, useNA ="always")
```
...
table(sub18.v26$brs_tot)
sub18.v26$brs_tot <- as.numeric(sub18.v26$brs_tot)

table(is.na(sub18.v26$brs_tot))

#  for loop for predictive cutoff point needed
rs_df <- data.frame("cutoff" = c(), "rs" = c())
for (i in 6:24) {
  brs_bin <- ifelse(sub18.v26$brs_tot >= i, TRUE, FALSE)
  model = lm(sub18.v26$sui_idea ~ brs_bin)
  rs_df <- rbind(rs_df, c(i, summary(model)$r.squared))
}
...
sub18.v26 <- sub18.v26 %>%
  ...
  mutate(brs_dum = case_when(brs_dum == 1 ~ 1,
                             brs_dum == 0 ~ 0)) %>%
  filter(!is.na(brs_dum))
sub18.v26$brs_dum <- as.logical(sub18.v26$brs_dum)

# output
rs_df_arranged[1,1]
table(sub18.v26$brs_tot, useNA = "always")
table(sub18.v26$brs_dum, useNA = "always")
```
...
# build table for absolute missingness based on school2
school2 <- count(sub18.v28, school2)
school2_ncol <- ncol(school2)
...
for (j in 1:(length(var_names))) {
for (i in 1:nrow(school2)) {   # i corresponds to rows, j to columns
  school2[i, 2 + j] <- sum(!is.na(sub18.v28[sub18.v28$school2 == school2[[i,1]], var_names[j]]))
}
}
# add percentage in each column
school2_m <- as.matrix(school2[-1]) 
...
#create skeleton of missingness matrix
var <- count(sub18.v28, sub18.v28[var_names[k]])
var_ncol <- ncol(var)
...
for (j in 1:(length(var_names))) {
for (i in 1:nrow(var)) {   # i corresponds to rows, j to columns
  var[i, 2 + j] <- sum(!is.na(sub18.v28[sub18.v28[[var_names[k]]] == var[[i,1]], var_names[j]]))
}
}
# add percentage in each column
var_m <- as.matrix(var[-1]) 
...
sub18_sem <- sub18_sem %>% 
  # mutate_if(is.numeric, as.factor) %>% 
  data.matrix()
# sub18_sem <- na.omit(sub18_sem)
view(sub18_sem)   # check output

# # xlsx output
sub18_sem_out <- as.data.frame(sub18_sem)
save(sub18_sem_out , file = "sub18_nondummy.RData")
load("sub18_nondummy.RData")
write_xlsx(sub18_sem_out, path = "sub18_nondummy.xls", col_names = TRUE, format_headers = TRUE)
```
...
sub18_sem <- sub18_sem %>% 
  ...
  data.matrix()
sub18_sem <- na.omit(sub18_sem)
head(sub18_sem)   # check output
```

# SEM model with partial cont and dummy
```{r si_model_tr1}
## Dummy col SEM w/ continuous
results_sub18_com <- dummy_cols(sub18_sem, select_columns = c("si_type", "sexual", "school2_type"),
                         remove_first_dummy = TRUE, remove_selected_columns = TRUE)
#view(results_tr_com1)
...
fit_sub18 <- sem(SI_model_sub18, data=results_sub18_com, ordered=T)
summary_sub18 <- summary(fit_sub18, fit.measures=TRUE, standardized = TRUE)

    ## running NULL model, baseline model RMSEA
nullRMSEA(fit_sub18, scaled = FALSE, silent = FALSE)

    ## modification indices
modificationindices(fit_sub18, minimum.value = 20)
```
...
fit_sub18M <- sem(SI_model_subM, data=results_sub18_com, ordered=T)
summary_sub18M <- summary(fit_sub18M, fit.measures=TRUE, standardized = TRUE)

    ## running NULL model, baseline model RMSEA
nullRMSEA(fit_sub18M, scaled = FALSE, silent = FALSE)