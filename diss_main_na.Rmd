...
SI_model_tr1 <- '
                # measurement model
                  ...
                  prem  =~ age_2 + age_3 + sexual_2 + sexual_3 + gender_tgd + sib_freq + 
                           ...
                           school2_type_2 + school2_type_3 + activ_yn + ins_cover + gpa_sr + 
                           binge + psyhx + fincur + drugs_yn + assault + drug_mar
...
SI_model_tr_M <- '
                # measurement model
                   si =~  si_type_2 + si_type_3 + si_type_4
                   prem =~ age_2 + age_3 + sexual_2 + sexual_3 + gender_tgd + sib_freq + 
                           international + ed_any + dx_mh + meds_count + religios + school2_type_2 + 
                           school2_type_3 + activ_yn + ins_cover + gpa_sr + binge + psyhx + fincur + 
