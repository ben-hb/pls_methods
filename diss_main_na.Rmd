...
```{r CLM environment}
clm_env <- traindf.v15 %>% select(si_type, religios, residenc, activ_none, school2_type, 
...
clm_env2 <- clm(si_type ~ religios + residenc + activ_none + school2_type + international +
                military, 
                data = clm_env)
summary(clm_env2)
coef(clm_env2)
...
traindf.v16 <- traindf.v16 %>% 
  ...
  filter(!is.na(ins_no))   
traindf.v16$ins_no <- as.logical(traindf.v16$ins_no)
table(traindf.v16$ins_no, useNA = "always")   # check output
...
traindf_le <- traindf.v19 %>% select(ins_no, gpa_sr, aca_impa, fincur, binge,
...
## EFA LE
```{r le_pca}
traindf_le <- traindf.v19 %>% select(ins_no, gpa_sr, aca_impa, fincur, 
...
results_le <- dummy_cols(traindf_le, select_columns = c("ins_no", "gpa_sr", "aca_impa", "fincur",
                                                        "binge", "drugs_yn", "drug_mar", "assault", "psyhx"),
                         remove_first_dummy = TRUE, remove_selected_columns = TRUE)
...
```{r clm_LE}
clm_le <- traindf.v19 %>% select(si_type, ins_no, gpa_sr, aca_impa, fincur, 
                                 assault, binge, drugs_yn, drug_mar, psyhx)
clm_le <- na.omit(clm_le)

# run regression
clm_le <- clm(si_type ~ ins_no + gpa_sr + aca_impa + fincur + assault + binge + 
...
traindf_prem <- traindf.v19 %>% select(si_type, age, sexual, gender_tgd, sib_freq, race, ed_any, dx_mh, 
                                       meds_count, residenc, religios, activ_no, school2_type, ins_no, military,
...
```{r satisfied_overall}
traindf.v26 <- traindf.v26 %>%
  mutate(satisfied_overall = case_when(satisfied_overall == 1 ~ 6,
...
```{r inf}
traindf.v26$inf_1[is.na(traindf.v26$inf_1)] <- 1
traindf.v26$inf_2[is.na(traindf.v26$inf_2)] <- 1
traindf.v26$inf_3[is.na(traindf.v26$inf_3)] <- 1
traindf.v26$inf_4[is.na(traindf.v26$inf_4)] <- 1
traindf.v26$inf_5[is.na(traindf.v26$inf_5)] <- 1
traindf.v26$inf_6[is.na(traindf.v26$inf_6)] <- 1
traindf.v26$inf_7[is.na(traindf.v26$inf_7)] <- 1
...
var_names <- c(
  ...
  # environment
  "religios", "school2_type", "activ_no", "international", "military", "residenc",
  # life events
...
SI_model_tr1 <- '
                # measurement model
                  ...
                  prem =~  sib_freq + sexual_2 + sexual_3 + gender_tgd +  
                           ...
                           school2_type_2 + school2_type_3 + activ_no + ins_no + 
...
```{r Activities}
# set all NAs in actvities equal to 0
test1.v14$activ_ac[is.na(test1.v14$activ_ac)] <- 1
test1.v14$activ_athc[is.na(test1.v14$activ_athc)] <- 1
test1.v14$activ_athv[is.na(test1.v14$activ_athv)] <- 1
test1.v14$activ_athi[is.na(test1.v14$activ_athi)] <- 1
test1.v14$activ_cs[is.na(test1.v14$activ_cs)] <- 1
test1.v14$activ_cu[is.na(test1.v14$activ_cu)] <- 1
test1.v14$activ_da[is.na(test1.v14$activ_da)] <- 1
test1.v14$activ_fs[is.na(test1.v14$activ_fs)] <- 1
test1.v14$activ_gs[is.na(test1.v14$activ_gs)] <- 1
test1.v14$activ_gov[is.na(test1.v14$activ_gov)] <- 1
test1.v14$activ_mp[is.na(test1.v14$activ_md)] <- 1
test1.v14$activ_md[is.na(test1.v14$activ_none)] <- 1
test1.v14$activ_soc[is.na(test1.v14$activ_soc)] <- 1
test1.v14$activ_rel[is.na(test1.v14$activ_rel)] <- 1
test1.v14$activ_art[is.na(test1.v14$activ_art)] <- 1
test1.v14$activ_other[is.na(test1.v14$activ_other)] <- 1
...
test1.v14 <- test1.v14 %>% 
  mutate(activ_no = case_when(activ_none == 1 ~ 1,
                              ...
                              activ_other == 1 ~ 0)) %>%
  filter(!is.na(activ_no))
test1.v14$activ_no <- as.logical(test1.v14$activ_no)

table(test1.v14$activ_no, useNA = "always")     # tabulate and check output
jarque.bera.test(test1.v14$activ_no)
...
test1.v16 <- test1.v14 %>% 
  mutate(ins_no = case_when((ins_1 == 1 | ins_mh == 4 | ins_mh == 5 | ins_ade == 3) ~ 1,   # inadequate coverage
                               (ins_1 == 0 | ins_mh == 1 | ins_mh == 2 | ins_ade == 2) ~ 0)) %>% # adequate MH coverage
  filter(!is.na(ins_no))   
test1.v16$ins_no <- as.logical(test1.v16$ins_no)
table(test1.v16$ins_no, useNA = "always")   # check output
jarque.bera.test(test1.v16$ins_no)
...
## Informal Mental Health Support
```{r inf}
test1.v26$inf_1[is.na(test1.v26$inf_1)] <- 1
test1.v26$inf_2[is.na(test1.v26$inf_2)] <- 1
test1.v26$inf_3[is.na(test1.v26$inf_3)] <- 1
test1.v26$inf_4[is.na(test1.v26$inf_4)] <- 1
test1.v26$inf_5[is.na(test1.v26$inf_5)] <- 1
test1.v26$inf_6[is.na(test1.v26$inf_6)] <- 1
test1.v26$inf_7[is.na(test1.v26$inf_7)] <- 1
...
```{r Activities}
# set all NAs in actvities equal to 0
sub18.v14$activ_ac[is.na(sub18.v14$activ_ac)] <- 1
sub18.v14$activ_athc[is.na(sub18.v14$activ_athc)] <- 1
sub18.v14$activ_athv[is.na(sub18.v14$activ_athv)] <- 1
sub18.v14$activ_athi[is.na(sub18.v14$activ_athi)] <- 1
sub18.v14$activ_cs[is.na(sub18.v14$activ_cs)] <- 1
sub18.v14$activ_cu[is.na(sub18.v14$activ_cu)] <- 1
sub18.v14$activ_da[is.na(sub18.v14$activ_da)] <- 1
sub18.v14$activ_fs[is.na(sub18.v14$activ_fs)] <- 1
sub18.v14$activ_gs[is.na(sub18.v14$activ_gs)] <- 1
sub18.v14$activ_gov[is.na(sub18.v14$activ_gov)] <- 1
sub18.v14$activ_mp[is.na(sub18.v14$activ_md)] <- 1
sub18.v14$activ_md[is.na(sub18.v14$activ_none)] <- 1
sub18.v14$activ_soc[is.na(sub18.v14$activ_soc)] <- 1
sub18.v14$activ_rel[is.na(sub18.v14$activ_rel)] <- 1
sub18.v14$activ_art[is.na(sub18.v14$activ_art)] <- 1
sub18.v14$activ_other[is.na(sub18.v14$activ_other)] <- 1
...
sub18.v14 <- sub18.v14 %>% 
  mutate(activ_no = case_when(activ_none == 1 ~ 1,
                              ...
                              activ_other == 1 ~ 0)) %>%
  filter(!is.na(activ_no))
sub18.v14$activ_no <- as.logical(sub18.v14$activ_no)

table(sub18.v14$activ_no, useNA = "always")     # tabulate and check output
jarque.bera.test(sub18.v14$activ_no)
```
...
sub18.v16 <- sub18.v14 %>% 
  mutate(ins_no = case_when((ins_1 == 1 | ins_mh == 4 | ins_mh == 5 | ins_ade == 3) ~ 1,   # inadequate coverage
                               (ins_1 == 0 | ins_mh == 1 | ins_mh == 2 | ins_ade == 2) ~ 0)) %>% # adequate MH coverage
  filter(!is.na(ins_no))   
sub18.v16$ins_no <- as.logical(sub18.v16$ins_no)
table(sub18.v16$ins_no, useNA = "always")   # check output
...
```{r dep_impa}
sub18.v24 <- sub18.v22 %>%
  mutate(dep_impa = case_when(dep_impa == 1 ~ 1,  # minimal
                              dep_impa == 2 ~ 2,
                              dep_impa == 3 ~ 3,
                              dep_impa == 4 ~ 4)) %>%
  filter(!is.na(dep_impa))
...
```{r gad7_impa}
sub18.v24 <- sub18.v24 %>%
  mutate(gad7_impa = case_when(gad7_impa == 1 ~ 1,  # minimal
                               gad7_impa == 2 ~ 2,
                               gad7_impa == 3 ~ 3,
                               gad7_impa == 4 ~ 4)) %>%
  filter(!is.na(gad7_impa))
...
## Informal Mental Health Support
```{r inf}
sub18.v26$inf_1[is.na(sub18.v26$inf_1)] <- 1
sub18.v26$inf_2[is.na(sub18.v26$inf_2)] <- 1
sub18.v26$inf_3[is.na(sub18.v26$inf_3)] <- 1
sub18.v26$inf_4[is.na(sub18.v26$inf_4)] <- 1
sub18.v26$inf_5[is.na(sub18.v26$inf_5)] <- 1
sub18.v26$inf_6[is.na(sub18.v26$inf_6)] <- 1
sub18.v26$inf_7[is.na(sub18.v26$inf_7)] <- 1
