...
results_tr_com1 <- dummy_cols(traindf_sem1, select_columns = c("si_type", "age", "sexual", "talk", "inf", "race", "school2_type"),
...
SI_model_tr1 <- '
                # measurement model
                  ...
                  prem  =~ age_2 + age_3 +
                           ...
                           meds_count + satisfied_overall +  religios + 
                           school2_type_2 + school2_type_3 + activ_yn + talk_2 + talk_3 + talk_4 +
                           ins_cover + gpa_sr + binge + psyhx + fincur + drugs_yn + assault + drug_mar
...
fit_train1 <- sem(SI_model_tr1, data=results_tr_com1)
                  # ordered = c("sib_freq", "satisfied_overall", "religios", "dep_impa",
...
# SEM -- all dummies
```{r SEM, all dummies}
results_tr_sem_d <- dummy_cols(traindf_sem, select_columns = c(
    # # outcome var
    "si_type",
    # diathesis
    "age", "sexual", "gender_tgd", "sib_freq", "race", "ed_any", "dx_mh", "meds_count",
...
fit_train_d <- sem(SI_model_trD, data=results_tr_sem_d)
