...
fit_test1 <- sem(SI_model_test1, data=results_test_com2)
                  # ordered = c("sib_freq", "satisfied_overall", "religios", "dep_impa",
                  #             "gpa_sr", "aca_impa", "persist", "flourish_dum", "belong1", "gad7_impa"))
summary_testn <- summary(fit_test1, fit.measures=TRUE, standardized = TRUE)


# MODEL PREDICTION
    ## model diagnostics
fitmeasures(fit_test1)
fitted(fit_test1)
inspect(fit_test1, what="cor.all")
parameterEstimates(fit_test1)
...
mod_testfit1 <- cfa(SI_model_test1, data = results_test_com2)
mi <- modindices(mod_testfit1, sort = TRUE, maximum.number = 10)
View(mi)
mi[mi$op == "=~",] %>% View()

# MODEL ESTIMATES
semPaths(fit_test1, what = "col", whatLabels = "std", style = "mx", rotation = 1, layout = "spring", 
    nCharNodes = 8, shapeMan = "rectangle", sizeMan = 8, sizeMan2 = 8)

fit_test3 <- sem(SI_model_test1, data=results_test_com2)
