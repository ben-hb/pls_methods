...
summary(fit_train3, fit.measures = T)
...
fitmed <- sem(med_model, data = Data)
summary(fitmed)

# path analysis
semPaths(fitmed, title = F, curvePilot = T, "par", weighted = FALSE, nCharNodes = 7, 
    shapeMan = "rectangle", sizeMan = 15, sizeMan2 = 10)

fitmed2 <- sem(model, data = Data2)
summary(fitmed2)

# lavaan.diagram(fit2)
semPaths(fitmed2, title = F, curvePilot = T, "par", weighted = FALSE, nCharNodes = 7, 
