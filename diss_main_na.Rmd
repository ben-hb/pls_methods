...
testdf_sem <- testdf.v27 %>% select(
  ...
  # environment
  satisfied_overall, religios, school2_type, activ_yn,
  # life events
  ins_cover, gpa_sr, binge, psyhx, fincur, drugs_yn, assault, drug_mar,
  # defeat
  aca_impa, dep_type, anx_type,
...
results_test_com1 <- dummy_cols(testdf_sem5, select_columns = c("si_type", "age", "sexual",
                                                                "race", "school2_type"),
                         remove_first_dummy = TRUE, remove_selected_columns = TRUE)
...
SI_model_test1 <- '
                # measurement model
                  ...
                  prem  =~ age_2 + age_3 +
                           ...
                           meds_count + religios + drug_mar +
                           school2_type_2 + school2_type_3 + activ_yn + assault + 
                           ins_cover + gpa_sr + binge + psyhx + fincur + drugs_yn
