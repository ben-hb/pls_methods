...
results_test_com <- dummy_cols(testdf_sem5, select_columns = c("si_type", "age", "sexual", "inf", "anx_type", "dep_type",
...
fit_test1 <- sem(SI_model_test1, data=results_test_com2)
                  # ordered = c("sib_freq", "satisfied_overall", "religios", "dep_impa",
                  #             "gpa_sr", "aca_impa", "persist", "flourish_dum", "belong1", "gad7_impa"))
summary_test1 <- summary(fit_test1, fit.measures=TRUE, standardized = TRUE)
