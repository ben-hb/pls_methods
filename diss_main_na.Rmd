...
table(traindf.v10$religios)       # Check output
```
...
traindf.v13 <- traindf.v13 %>%
  mutate(discrim = case_when(discrim == 1 ~ 1,
                             ...
                             discrim == 5 ~ 5,
                             discrim == 6 ~ 6))
table(traindf.v13$discrim, useNA = "always")
...
table(traindf.v14$school2_type, useNA = "always")
...
results_le <- dummy_cols(traindf_le, select_columns = c("ins_cover", "gpa_sr", "aca_impa", "psyhx",
                                                        "fincur", "binge","drugs_yn", "drug_mar", "assault"),
                         remove_first_dummy = TRUE)
...
traindf.v22 <- traindf.v22 %>%
  mutate(persist = case_when(persist == 1 ~ 1,
                             ...
                             persist == 6 ~ 6, 
                             is.na(persist) ~ 0))
table(traindf.v22$persist, useNA = "always")
...
traindf.v26 <- traindf.v26 %>%
  mutate(flourish_dum = case_when(is.na(flourish) ~ 0,
                                  flourish > 50 ~ 5,
                                  flourish > 40 ~ 4,
                                  flourish > 30 ~ 3,
                                  flourish > 20 ~ 2,
...
results_corr = results_corr[complete.cases(results_corr),]
# run a correlation and drop the insignificant ones 
sig <- 0.8
...
fit_train <- sem(SI_model_tr, data=results_tr_sem)
                 ...
                 "meds_count_1", "meds_count_2", "meds_count_3", "meds_count_4",
                 "meds_count_5", "meds_count_6", "satisfied_overall_2", "satisfied_overall_3",
                 "satisfied_overall_4", "satisfied_overall_5", "satisfied_overall_6",
                 "discrim_2", "discrim_3", "discrim_4", "discrim_5", "discrim_6",
                 "gpa_sr_1", "gpa_sr_2", "gpa_sr_3", "gpa_sr_4", "aca_impa_2", "aca_impa_3",
                 "aca_impa_4", "dep_type_2", "dep_type_3", "dep_type_4", "dep_type_5",
                 "anx_type_2", "anx_type_3", "anx_type_4", "persist_2", "persist_3",
                 "persist_4", " persist_5", "persist_6,  dep_secret_1", " dep_secret_2",
                 "dep_secret_3", "dep_secret_4", "dep_secret_5", "dep_secret_6",
                 "dep_impa_1", " dep_impa_2", " dep_impa_3", " dep_impa_4",
                 "gad7_impa_1", " gad7_impa_2", " gad7_impa_3", " gad7_impa_4",
                 "percneed_cur_1", "percneed_cur_2", "percneed_cur_3", "percneed_cur_4",
                 "percneed_cur_5", "percneed_cur_6","flourish_dum_2", "flourish_dum_3",
                 "flourish_dum_4", "flourish_dum_5", "flourish_dum_NA", "belong1_2",
                 "belong1_3", "belong1_4", "belong1_5", "belong1_6", "belong_1_NA"))
fit_train@SampleStats@cov
