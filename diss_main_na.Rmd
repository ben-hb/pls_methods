...
data.v6$race[str_detect(data.v6$race_other_text, "[E|e]urasian")] <- 85
...
traindf_dia <- traindf.v12 %>% select(age, sexual, gender_tgd, finpast, sib_freq, race, 
                                      body_sr, ed_any, dx_mh, meds_count)
...
results_env <- dummy_cols(traindf_env, select_columns = c("discrim", "religios", "residenc", "activ_yn", "divers",
                                                         "school2_type", "satisfied_overall", "talk"),
                          remove_first_dummy = TRUE)
