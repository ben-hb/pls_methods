...
results_tr_com1 <- dummy_cols(traindf_sem1, select_columns = c("si_type", "age", "sexual", "inf", "race", "talk", "school2_type"),
                         remove_first_dummy = TRUE, remove_selected_columns = TRUE)
...
SI_model_tr_M <- '
                # measurement model
                   ...
                   prem  =~ age_2 + age_3 + sexual_2 + sexual_3 + gender_tgd + sib_freq + 
                           race_2 + race_3 + race_4 + race_5 + ed_any + dx_mh +
