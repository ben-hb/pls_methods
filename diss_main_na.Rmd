...
SI_model_trD <- '# measurement model
                  ...
                  prem  =~ age_19 + age_20 + age_21 + age_22 + age_23 + age_24 + age_25 +
                           sexual_2 + sexual_3 +
                           gender_tgd_1 + 
                           sib_freq_1 + sib_freq_2 +
                           race_2 + race_3 + race_4 + race_5 + 
                           ed_any_1 + 
                           dx_mh_1 +
                           meds_count_1 + meds_count_2 + meds_count_3 + 
                           talk_2 + talk_3 + talk_4 + 
                           religios_2 + religios_3 + religios_4 + religios_5 + 
                           school2_type_2 + school2_type_3 + 
                           activ_yn_1 + 
                           ins_cover_1 + 
                           gpa_sr_2 + gpa_sr_3 + gpa_sr_4 + gpa_sr_5 +
                           binge_1 + 
                           psyhx_1 + 
                           fincur_1 + 
                           drugs_yn_1 + 
...
# results_corr <- NA_preproc(results_tr_sem1)
# sig <- 0.4
# 
# # run a correlation and drop the insignificant ones 
# corr <- cor(results_corr, use = "pairwise.complete.obs")                               
