...
# t-SNE
tsne<-Rtsne(results_dia2,dims=2,perplexity=30,verbose=T,max_iter=1500,check_duplicates=F)

# display the results of t-SNE
cols <- rainbow(length(unique(results_dia2)))
plot(tsne$Y, t='n')
text(tsne$Y, labels=as.numeric(results_dia2[,1]), col=cols[results_dia2[,1]])
```
...
# t-SNE
tsne<-Rtsne(results_env2,dims=2,perplexity=30,verbose=T,max_iter=1500,check_duplicates=F)

# display the results of t-SNE
cols <- rainbow(length(unique(results_env2)))
plot(tsne$Y, t='n')
text(tsne$Y, labels=as.numeric(results_env2[,1]), col=cols[results_env2[,1]])
...
# t-SNE
colors = rainbow(length(unique(results_def2)))
names(colors) = unique(results_def2)

tsne_def<-Rtsne(results_def2,dims=2,perplexity=30,verbose=T,max_iter=1500,check_duplicates=F)

plot(tsne_def$Y,t='n',main='tsne',xlim=c(-30,30),ylim=c(-30,30))
text(tsne_def$Y,labels=train$results_def2,col = colors[results_def2])
legend(25,5,legend=unique(train$results_def2),col = colors,,pch=c(1))
