...
clm_mm <- clm(si_type ~ inf + flourish_dum + belong1 + mh_stigma + brs_dum, data = clm_mm)
...
var_names <- c(
  ...
  "dx_adhd", "dx_pers", "meds_sti", "meds_count",
  # environment
...
SI_tr_fit <- cfa(SI_model_tr, data = results_sem, estimator = "MLM", orthogonal = FALSE, std.lv = FALSE)
summary(SI_tr_fit, fit.measures = TRUE, standardized = TRUE, rsquare = TRUE)

SI_tr_fitau <- cfa(SI_tr_fit, data = results_sem, estimator = "MLM", orthogonal = FALSE, std.lv = FALSE)
summary(SI_tr_fitau, fit.measures = TRUE, standardized = TRUE, rsquare = TRUE)
```
...
S <- getCov(lower, names=c("dia_sem","env_sem","le_sem","def_sem","entrap_sem", "mm_sem", "si_sem"))
