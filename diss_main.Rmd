...
traindf.v17$assault_sex[is.na(traindf.v17$assault_sex)] <- 0
traindf.v17$assault_emo[is.na(traindf.v17$assault_emo)] <- 0
traindf.v17$assault_phys[is.na(traindf.v17$assault_phys)] <- 0
...
table(traindf.v17$trauma_year)
traindf.v17$trauma_year <- as.logical(traindf.v17$trauma_year)
```
...
traindf.v18$gpa_sr <- as.factor(traindf.v18$gpa_sr)
```
...
traindf.v24$percneed_cur <- as.factor(traindf.v24$percneed_curqa1`)
```
...
clm_mm <- glm(si_type ~ inf + flourish + belong1 + mh_stigma + brs_tot, data = clm_mm)
...
# Run preliminary stats on sample pre-split
var_names <- c(
  # diathesis
  "age", "sexual", "gender_noncis", "sib_freq", "race", "ed_any", "dx_dep", "dx_bi", "dx_tr", "dx_anx", 
  "dx_adhd", "meds_count",
...
varall_desc <- describe(var_names) %>% view()
