...
data_mm <- data.v27 %>% select(inf, flourish_dum, belong1, belong2, stig_pcv_2, stig_pcv_3, brs_dum)
data <- data_mm
sig <- 0.6
...
results_mm <- dummy_cols(data_mm, select_columns = c("inf", "flourish_dum", "belong1", "belong2",
...
```{r tsne_mm}
# set up df for t-sne
data_mm2 <- data.v27 %>% select(inf, flourish_dum, belong1, belong2, stig_pcv_2, stig_pcv_3, brs_dum)
...
Variables for consideration:  inf, flourish_dum, belong1, belong2, stig_pcv_2, stig_pcv_3, brs_dum
```{r CLM mm}

clm_mm <- data.v27 %>% select(si_type, inf, flourish_dum, belong1, belong2, stig_pcv_2, stig_pcv_3, brs_dum)

clm_mm <- NA_preproc(clm_mm)
clm_mm <- as.data.frame(clm_mm)

clm_mm <- clm(si_type ~ inf + flourish_dum + belong1 + belong2 + stig_pcv_2 + 
