...
```{r tsne_le}
# PCA map with eigenvalues
traindf_le2 <- traindf.v19 %>% select(ins_cover, trauma_year, gpa_sr, aca_impa, drug_mar, fincur, binge_fr, psyhx, drugs_yn)
results_le2 <- dummy_cols(traindf_le2, remove_first_dummy = TRUE)
