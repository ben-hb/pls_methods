...
```{r T-SNE ENV}
# PCA map with eigenvalues
results_env2 <- dummy_cols(data.v15, select_columns = c("si_type", "discrim", "religios", "env_mh", "residenc", "ther_vis",
                                                       "activ_yn", "divers", "school2_type", "satisfied_overall", 
                                                       "ther_vis", "talk", "military", "international"),
                          remove_first_dummy = TRUE)
...
ecb = function(x,y){ 
  plot(x,t='n'); text(x,labels=results_env2, col=colors[results_env2]) 
  }

tsne_env <- tsne(results_env2, epoch_callback = ecb, perplexity=50)
...
ecb = function(x,y){ 
  plot(x,t='n'); text(x,labels=results_le2, col=colors[results_le2]) 
  }

tsne_le2 <- tsne(results_le2, epoch_callback = ecb, perplexity=50)
```
...
ecb = function(x,y){ 
  plot(x,t='n'); text(x,labels=results_def2, col=colors[results_def2]) 
  }

tsne_def2 <- tsne(results_def2, epoch_callback = ecb, perplexity=50)
```
