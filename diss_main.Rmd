...
ggplot(dia_data, aes(x = si_type, y = resid)) +
...
clm_env <- data.v15 %>% select(si_type, discrim, religios, env_mh, residenc, ther_vis, activ_yn, divers, school2_type, 
...
ggplot(env_data, aes(x = si_type, y = resid)) +
geom_point(color = "purple", alpha = 0.15) +
geom_smooth(method = "lm")
