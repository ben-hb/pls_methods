...
```{r save dataset}
results_tr_df <- as.matrix(results_tr_sem2)
...
SI_model_tr <- '
              # measurement model
                  si_sem =~  si_type_4 + si_type_3 + si_type_2 + si_type_NA
                  
                  dia_sem =~ age_NA + age_19 + age_20 + age_21 + age_22 + age_23 + age_24 + age_25 +
                             sexual_lgb + sexual_qq + sexual_non + sexual_het + 
                             gender_tgd_2
                  ...
                  env_sem =~ divers_2 + divers_3 + divers_4 + divers_5 + divers_6 + divers_NA +
                             ...
                             talk_for + talk_info + talk_com + talk_no +
...
fit <- cfa(SI_model_tr, data = results_tr_sem,
