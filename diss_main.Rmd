...
# model.M <- lm( ~ grades*gender, traindf_sem1)
...
## Dummy col SEM w/ continuous
results_pls_tr <- traindf.v28 %>% select(
  # outcome var
  si_type,
  # prem
  sib_freq, sexual, gender_tgd, ed_any, dx_mh, medther, gpa_sr,
  psyhx, fincur, drugs_yn, assault,
  # deftrap
  dep_type, aca_impa, anx_type, dep_impa, gad7_impa,
  # tsm, motivational moderators
  aaq_dum, persist,flourish_dum, inf, belong1, satisfied_overall, mh_stigma)

results_pls_tr <- dummy_cols(results_pls_tr, select_columns = c("si_type", "sexual"),
                         remove_first_dummy = TRUE, remove_selected_columns = F)
# create sem matrix 
results_pls_tr <- as.data.frame(results_pls_tr)

#save full var set for SEM
save(results_pls_tr, file = "results_pls_tr.RData")

save("results_pls_tr", file="~/Desktop/results_pls_tr.RData")
load("~/Desktop/results_pls_tr.RData")
...
# outer model
imv_blocks = list(2:12, 11:15, 32:39, 40:41, )
...
indProd(results_tr_com1, var1, var2, var3 = NULL, match = TRUE, meanC = TRUE,
...
model <- '
#direct effects
si ~ c*var1 + cw*interaction +b*var2
