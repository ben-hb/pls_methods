...
test18_sem2 <- as.data.frame(test18_sem)
save(test18_sem2 , file = "test18_sem2.RData")
load("test18_sem2.RData")
write_xlsx(traindf_sem_out, path = "test18_sem2.xls", col_names = TRUE, format_headers = TRUE)
```
...
test20_sem2 <- as.data.frame(test20_sem)
save(test20_sem2 , file = "test20_sem2.RData")
load("test18_sem2.RData")
write_xlsx(test20_sem2, path = "test20_sem2.xls", col_names = TRUE, format_headers = TRUE)
