...
clm_env <- clm2(si_type ~ discrim + satisfied_overall + ther_vis + talk + activ_yn + international + 
...
## CLM TSM
```{r CLM TSM}
clm_tsm <- data.v23 %>% select(si_type, persist, anx_mod, anx_sev, dep_secret, AAQ_tot)
