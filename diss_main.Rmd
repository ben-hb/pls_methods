...
# tabulate and check output
table(traindf.v17$assault_sex) 
table(traindf.v17$assault_emo)
table(traindf.v17$assault_phys)
```
...
traindf_le <- traindf.v19 %>% select(ins_cover, gpa_sr, aca_impa, fincur, binge_fr, drugs_yn,
                                     assault_phys, assault_sex, assault_emo, psyhx)
...
results_le <- dummy_cols(traindf_le, select_columns = c("ins_cover", "assault_phys", "assault_sex",
                                                        "assault_emo", "gpa_sr", "psyhx", "aca_impa", 
                                                        "fincur", "binge_fr", "drugs_yn"),
                         remove_first_dummy = TRUE)
...
```{r clm_LE}
clm_le <- traindf.v19 %>% select(si_type, ins_cover, gpa_sr, aca_impa, fincur, assault_sex,
                                 assault_emo, assault_phys, binge_fr, psyhx, drugs_yn)
...
SI_model_tr <- '
              # measurement model
                  ...
                  le_sem =~  ins_cover_1 + ins_cover_NA +
                             ...
                             assault_emo_2 + assault_emo_NA +
                             assault_phys_2 + assault_phys_NA +
                             assault_sex_2 + assault_sex_NA
               ...
               # covars
                  ...
                  dx_dep_2 ~~ dx_bi_2
                  dx_dep_2 ~~ dx_tr_2
                  assault_emo_2 ~~ assault_sex_2
                  assault_emo_2 ~~ assault_phys_2
                  assault_sex_2 ~~ assault_phys_2
