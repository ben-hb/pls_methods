...
traindf.v9 <- subset(results_sem, split == TRUE)
testdf.v9 <- subset(results_sem, split == FALSE)
...
table(traindf.v9$wcs_1_f)
table(traindf.v9$wcs_1_m)
table(traindf.v9$wcs_1_o)

table(traindf.v9$wcs_2)
table(traindf.v9$wcs_3)
table(traindf.v9$wcs_4)
table(traindf.v9$wcs_5)

traindf.v9 = subset(traindf.v9, select= -c(wcs_1_f, wcs_1_m, wcs_1_o, 
...
corr_simple <- function(traindf=traindf_dia, sig=0.6){
  ...
  corr <- as.traindf.frame(as.table(corr))                   # turn into a 3-column table
