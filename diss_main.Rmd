...
SI_model_tr <- '
              # measurement model
                  ...
                  dia_sem =~ age_NA + age_19 + age_20 + age_21 + age_22 + age_23 + age_24 + age_25 +
                             sexual_het + sexual_lgb + sexual_qq + sexual_non +
                             gender_tgd_2 + gender_tgd_NA +
                             sib_freq_NA + sib_freq_2 + sib_freq_3 + sib_freq_4 + sib_freq_5 + 
                                sib_freq_6 + sib_freq_7 +
                             race_bla + race_ame + race_asi + race_his + race_pac + race_ara + 
                                race_whi + race_oth + race_non +
                             ed_any_NA + ed_any_2 +
                             dx_dep +
                             dx_bi + 
                             dx_anx + 
