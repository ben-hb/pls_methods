...
clm_mm <- clm(si_type ~ inf + flourish + belong1 + belong2 + belong8 + belong9 + stig_pcv_2 + stig_pcv_3 + brs_tot, data = clm_mm)
...
var_names <- c(
  # diathesis
  "age", "sexual", "gender_noncis", "finpast", "sib_freq", "race", "body_sr", "ed_any", "audit_tot", "dx_dep", "dx_bi",
  "dx_ea", "dx_tr", "dx_adhd", "dx_pers", "meds_sti", "meds_dep", "meds_psy", "meds_anx", "meds_mood",
  "meds_sle", "meds_count",
  # environment
  "env_mh", "ther_vis", "divers", "satisfied_overall", "residenc", "talk", "religios", "discrim", "school2_type", "activ_yn",
  # life events
  "ins_cover", "gpa_sr", "assault_phys", "binge_fr", "assault_sex", "assault_emo", "psyhx", "fincur", "drugs_yn", "abuse_year",
  # defeat
  "aca_impa", "deprawsc", 
  # threats to self-moderation
