...
## EFA LE
```{r le_pca}
traindf_le <- traindf.v19 %>% select(ins_cover, gpa_sr, aca_impa, fincur, drug_mar, binge_fr, trauma_year, psyhx, drugs_yn)
...
results_le <- dummy_cols(traindf_le, select_columns = c("ins_cover", "trauma_year", "gpa_sr", "psyhx",
...
```{r clm_LE}
clm_le <- traindf.v19 %>% select(si_type, ins_cover, trauma_year, gpa_sr, aca_impa, fincur, drug_mar, binge_fr, psyhx, drugs_yn)
...
traindf_sem <- traindf.v28 %>% select(
  ...
  divers, satisfied_overall, talk, religios, discrim, school2_type, activ_yn, military,
  # life events
  ins_cover, gpa_sr, binge_fr, psyhx, fincur, drugs_yn,
  # defeat
  aca_impa, deprawsc,
  # threats to self-moderation
