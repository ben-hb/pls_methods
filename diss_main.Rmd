...
screeplot(eigval_le, type = "l", npcs = 15, main = "Screeplot of the first 10 PCs")
...
listclass=c("")
vardep=data.v19$sui_idea
result<-famdcontour(data=data.v19, results_le, listclass, vardep,title="FAMD Plots",selec=1)
```
...
ggbiplot(tsm_pca, labels=rownames(tsm_pca))
```
