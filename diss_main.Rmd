...
# save matrix
write_xlsx(school2, path = "sch2_missing_test.xlsx", col_names = TRUE, format_headers = TRUE)
```
...
view(missing_rates)
# save matrix
write_xlsx(missing_rates, path = "overall_missing_test.xlsx", col_names = TRUE, format_headers = TRUE)
```
...
names(missing_dfs) <- var_names
save(missing_dfs, file = "missing_dfs_test.RData")
load("missing_dfs_test.RData")
write_xlsx(missing_dfs, path = "missing_test.xlsx", col_names = TRUE, format_headers = TRUE)
```
