...
data_mm <- data.v27 %>% select(inf, flourish_dum, belong2, mh_stigma, brs_dum)
...
results_mm <- dummy_cols(data_mm, select_columns = c("inf", "flourish_dum", "belong2", "mh_stigma", "brs_dum"),
                         remove_first_dummy = TRUE)
...
clm_mm <- data.v27 %>% select(si_type, inf, flourish_dum, belong2, mh_stigma, brs_dum)

clm_mm <- NA_preproc(clm_mm)
clm_mm <- as.data.frame(clm_mm)

clm_mm <- clm(si_type ~ inf + flourish_dum + belong2 + mh_stigma + brs_dum, data = clm_mm)
...
var_names <- c(
  # diathesis
  "age", "sexual", "gender_noncis", "sib_freq", "race", "ed_any", "dx_dep", "dx_bi", "dx_tr", 
  "dx_anx, dx_adhd", "dx_pers", "meds_sti", "meds_count",
  # environment
  "divers", "satisfied_overall", "talk", "religios", "discrim", "school2_type", "activ_yn", "military",
  # life events
  "ins_cover", "gpa_sr", "binge_fr", "assault_sex", "psyhx", "fincur", "drugs_yn", "trauma_year", "drug_mar",
  # defeat
  "aca_impa", "deprawsc",
  # threats to self-moderation
  ...
  # motivational moderators
  "inf", "flourish_dum", "belong2", "mh_stigma", "brs_dum")  
