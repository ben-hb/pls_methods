...
## Dummy col SEM w/ continuous
results_test_com <- dummy_cols(test20_sem, select_columns = c("si_type", "sexual"),
                         remove_first_dummy = TRUE, remove_selected_columns = TRUE)
#view(results_tr_com1)
SI_model_20 <- '
                # measurement model
...
fit_test_20 <- sem(SI_model_20, data=results_test_com, ordered=T)
...
semPaths(fit_test_a, layout = "tree")
