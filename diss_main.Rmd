...
clm_tsm <- clm2(si_type ~ persist + anx_mod + anx_sev + dep_secret + AAQ_tot, data = clm_tsm)
...
clm_entrap <- clm2(si_type ~ dep_impa + gad7_impa + percneed_cur, data = clm_entrap)
