...
ggmaplot(eigval_env,
   ...
   genenames = as.vector("discrim", "religios", "env_mh", "residenc", "ther_vis",
...
# t-SNE
Labels <- results_env2
results_env2 <- as.factor(results_env2)
...
tsne <- Rtsne(results_env2, dims = 5, perplexity=30, verbose=TRUE, max_iter=500)
exeTimeTsne<- system.time(Rtsne(results_env2, dims = 2, perplexity=30, verbose=TRUE, max_iter=500))

## Plotting
plot(tsne$Y, t='n', main="tsne")
text(tsne$Y, labels=results_env2$si_type, col=colors[results_env2$si_type])
