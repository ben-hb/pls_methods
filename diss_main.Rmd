...
data_mm <- data.v27 %>% select(inf, flourish_dum, belong2, stig_pcv_2, stig_pcv_3, brs_dum)
...
results_mm <- dummy_cols(data_mm, select_columns = c("inf", "flourish_dum", "belong2", "stig_pcv_2", "stig_pcv_3", "brs_dum"),
                         remove_first_dummy = TRUE)
...
clm_mm <- data.v27 %>% select(si_type, inf, flourish_dum, belong1, stig_pcv_2, stig_pcv_3, brs_dum)

clm_mm <- NA_preproc(clm_mm)
clm_mm <- as.data.frame(clm_mm)

clm_mm <- clm(si_type ~ inf + flourish_dum + belong1 + stig_pcv_2 + stig_pcv_3 + brs_dum, data = clm_mm)
...
data_sem <- data.v28 %>% select(
  ...
  dep_impa, gad7_impa, percneed_cur,
  # motivational moderators
  inf, flourish_dum, belong1, stig_pcv_2, stig_pcv_3, brs_dum)
