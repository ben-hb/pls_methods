...
# new model introduction -- test data
```{r SI_test_new}
SI_test_new<- '
                # measurement model
                    si =~      si_type_3 + si_type_2 + si_type_4
...
fit_testM4 <- sem(SI_test_new, data=results_test_com1, ordered=T)
...
# xlsx output
results_test_com2 <- as.data.frame(results_test_com1)
save(results_test_com2, file = "results_test_com2.RData")
load("results_test_com2.RData")
write_xlsx(results_test_com2, path = "results_test_com2.xls", col_names = TRUE, format_headers = TRUE)
```
...
results_18_com <- as.data.frame(results_18_com)
save(results_18_com , file = "results_18_com.RData")
load("results_18_com.RData")
write_xlsx(traindf_sem_out, path = "results_18_com.xls", col_names = TRUE, format_headers = TRUE)
```
...
results_20_com <- as.data.frame(results_20_com)
save(results_20_com , file = "results_20_com.RData")
load("results_20_com.RData")
write_xlsx(results_20_com, path = "results_20_com.xls", col_names = TRUE, format_headers = TRUE)
