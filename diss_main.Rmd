...
clm_le <- clm(si_type ~ ins_cover + trauma_year + gpa_sr + aca_impa + fincur + binge_fr + drug_mar + psyhx + drugs_yn, 
              data = clm_le)
summary(clm_le)
coef(clm_le)
...
data_sem <- data.v28 %>% select(
  ...
  si_type,
  # diathesis
  age, sexual, gender_noncis, sib_freq, race, ed_any, dx_dep, dx_bi, dx_anx, dx_tr, dx_adhd, dx_pers, meds_count,
  # environment
  divers, satisfied_overall, residenc, talk, religios, discrim, school2_type, activ_yn, military,
  # life events
