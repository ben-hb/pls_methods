...
```{r Call packages}
# sample git change
# git change #2 electric boogaloo
library(assertive)
library(bestglm)
library(broom)
library(car)
...
# save training data
save(rtaindf.v29, file = "traindf_diss.RData")
load("traindf_diss.RData")
write_xlsx(results_sem, path = "traindf_diss.xls", col_names = TRUE, format_headers = TRUE)

# save test data
save(testdf.v29, file = "testdf_diss.RData")
load("testdf_diss.RData")
write_xlsx(results_sem, path = "testdf_diss.xls", col_names = TRUE, format_headers = TRUE)
```


# SEM ANALYSIS PREPARATION
...
#                   
#                 # structural model - regressions
#                   premotiv_sem =~ dia_sem + env_sem + le_sem
#                   motiv =~ def_sem + tsm_sem + entrap_sem + mm_sem
# 
#                 # residual covariances
#                    dep_impa~~gad7_impa
#                    meds_count~~dx_dep   '
