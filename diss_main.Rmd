...
save("data.pls", file="~/Desktop/results_pls_tr.RData")
...
#scales
imv_scales = list(
    c(rep("ord", 6), rep("num", 4), "ord", rep("num", 4),
    rep("ord", 5), "num", rep("ord", 2),"num", rep("ord", 2), "num")
)
# ordinal variable column numbers 
