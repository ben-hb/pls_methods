...
traindf_sem1 <- traindf.v28 %>% select(
  ...
  dep_impa, gad7_impa, percneed,
  # motivational moderators
  inf, flourish_dum, belong1, satisfied_overall, mh_stigma, talk, brs_tot)  #mh_stigma, 
...
SI_model_new<- '
                # measurement model
                    ...
                    diaenv =~  sib_freq + sexual_2 + sexual_3 + gender_tgd + ed_any +
                               dx_mh + medther + satisfied_overall + belong1 + international
                   
                    le =~  psyhx + gpa_sr + fincur + drugs_yn + assault + ins_no 
                    
                    deftrap =~ percneed + anx_type + dep_type
                    
                    mmtsm =~ aaq_dum + flourish + persist + inf + brs_tot
