...
results_all_com1 <- dummy_cols(data_sem_all, select_columns = c("si_type", "race", "residenc", "school2_type"),
                         remove_first_dummy = TRUE, remove_selected_columns = TRUE)

# xlsx output
save(results_all_com1, file = "data_all_pls.RData")
load("data_all_pls.RData")
write_xlsx(results_all_com1, path = "data_all_pls.xlsx", col_names = TRUE, format_headers = TRUE)
```
