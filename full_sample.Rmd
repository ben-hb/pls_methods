...
# create sem matrix 
data_sem1 <- data.matrix(data_sem1)
  
## Dummy col SEM w/ continuous
results_tr_com1 <- dummy_cols(data_sem1, select_columns = c("si_type", "race", "residenc", "school2_type"),
                         remove_first_dummy = TRUE, remove_selected_columns = TRUE)

# xlsx output
save(results_tr_com1, file = "data_pls.RData")
load("data_pls.RData")
write_xlsx(results_tr_com1, path = "data_pls.xlsx", col_names = TRUE, format_headers = TRUE)
```
