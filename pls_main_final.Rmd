...
jarque.bera.test(traindf.v13$ins_no)
...
traindf.v14$exp_leave <- as.numeric(traindf.v14$exp_leave)
table(traindf.v14$exp_community)
table(traindf.v14$exp_leave)
...
glm_prem <- glm(si_type ~ sexual + gender_tgd + sib_freq + race + ed_any + dx_mh + undercls + finpast +
                religios +  school2_type + international + residenc + meds_any + ins_no,
              data = glm_prem)
summary(glm_prem)
