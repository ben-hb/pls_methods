...
write_xlsx(results_tr_com1, path = "traindf_pls_new.xlsx", col_names = TRUE, format_headers = TRUE)
```
...
write_xlsx(results_test, path = "testdf_pls_new.xlsx", col_names = TRUE, format_headers = TRUE)
```
...
## Dummy col SEM w/ continuous
results_test_18 <- dummy_cols(test18_sem, select_columns = c("race", "residenc", "school2_type"),
                         remove_first_dummy = TRUE, remove_selected_columns = TRUE)
