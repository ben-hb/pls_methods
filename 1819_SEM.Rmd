...
save(data_sem3 , file = "data_nondummy.RData")
load("data_nondummy.RData")
write_xlsx(data_sem3, path = "data_nondummy.xls", col_names = TRUE, format_headers = TRUE)
```

## Create dummy vars
```{r dummy_cols SEM}
results_sem_1819 <- dummy_cols(data_sem2, select_columns = c(
    # outcome var
    "si_type",
    # diathesis
